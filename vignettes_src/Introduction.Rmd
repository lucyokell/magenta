...
```{r updated out S, fig.height=5, fig.width=7}
...
```{r update out with human save, results = 'hold'}
...
```{r all infected individual, fig.height=5, fig.width=7}
zetas <- out3[[n]]$Zetas
...
```{r convert barcode vectors, fig.height=5, fig.width=7}
...
```{r update out with human and mosquito, results = 'hold'}
...
```{r human update saves, results = 'hold'}
...
```{r coi summary saves, results = 'hold'}
...
```{r plot coi over time, fig.height=5, fig.width=7}
...
```{r coi summary saves long barcode, results = 'hold'}
...
```{r vals over time, fig.height=5, fig.width=7}
...
```{r coi summary saves different age, results = 'hold'}
...
```{r infected mosquites, fig.height=5, fig.width=7, results = 'hold'}
...
```{r fixation lattice, fig.height=5, fig.width=7}
...
```{r importation, fig.height=5, fig.width=7, results = 'hold'}
...
``` {r country example, fig.height=5, fig.width=7, results = 'hold'}
...
```{r ibd sufficient strains sim, results = 'hold'}
