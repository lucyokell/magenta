...
```{r update out with human and mosquito}
...
```{r plot coi over time, fig.height=5, fig.width=5}
...
```{r coi summary saves long barcode}
...
```{r coi summary saves different age}
