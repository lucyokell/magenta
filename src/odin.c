...
#endif
typedef struct odin_itn_irs_internal {
  double aD;
  double *age;
  ...
  double *delay_array_cov;
  double *delay_array_cov_;
  ...
  int dim_w;
  int dim_w_;
  int dim_weighted_clin_inc;
  int dim_weighted_clin_inc_1;
  int dim_weighted_clin_inc_12;
  int dim_weighted_clin_inc_2;
  int dim_weighted_clin_inc_3;
  int dim_whi;
  int dim_x_I;
  int dim_Y;
  int dim_Y_1;
  ...
  double *initial_T;
  double *initial_U;
  void *interpolate_eff_irs_vector;
  void *interpolate_eff_itn_vector;
  void *interpolate_ft;
  void *interpolate_int_itn_irs_on;
  double IRS_interval;
  double irs_loss;
  double *irs_vector;
  double ITN_interval;
  ...
  double *z_;
  double *zhi;
  bool odin_itn_irs_use_dde;
} odin_itn_irs_internal;
odin_itn_irs_internal* odin_itn_irs_get_internal(SEXP internal_p, int closed_error);
static void odin_itn_irs_finalise(SEXP internal_p);
SEXP odin_itn_irs_create(SEXP user);
void odin_itn_irs_initmod_desolve(void(* odeparms) (int *, double *));
SEXP odin_itn_irs_contents(SEXP internal_p);
SEXP odin_itn_irs_set_user(SEXP internal_p, SEXP user);
SEXP odin_itn_irs_set_initial(SEXP internal_p, SEXP t_ptr, SEXP state_ptr, SEXP odin_itn_irs_use_dde_ptr);
SEXP odin_itn_irs_metadata(SEXP internal_p);
SEXP odin_itn_irs_initial_conditions(SEXP internal_p, SEXP t_ptr);
void odin_itn_irs_rhs(odin_itn_irs_internal* internal, double t, double * state, double * dstatedt, double * output);
void odin_itn_irs_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal);
void odin_itn_irs_rhs_desolve(int * neq, double * t, double * state, double * dstatedt, double * output, int * np);
void odin_itn_irs_output_dde(size_t n_eq, double t, double * state, size_t n_output, double * output, void * internal_p);
SEXP odin_itn_irs_rhs_r(SEXP internal_p, SEXP t, SEXP state);
...
odin_itn_irs_internal* odin_itn_irs_get_internal(SEXP internal_p, int closed_error) {
  odin_itn_irs_internal *internal = NULL;
  if (TYPEOF(internal_p) != EXTPTRSXP) {
    Rf_error("Expected an external pointer");
  }
  internal = (odin_itn_irs_internal*) R_ExternalPtrAddr(internal_p);
  if (!internal && closed_error) {
    Rf_error("Pointer has been invalidated");
  }
  return internal;
}
void odin_itn_irs_finalise(SEXP internal_p) {
  odin_itn_irs_internal *internal = odin_itn_irs_get_internal(internal_p, 0);
  if (internal_p) {
    cinterpolate_free(internal->interpolate_eff_irs_vector);
    cinterpolate_free(internal->interpolate_eff_itn_vector);
    cinterpolate_free(internal->interpolate_ft);
    cinterpolate_free(internal->interpolate_int_itn_irs_on);
    internal->interpolate_eff_irs_vector = NULL;
    internal->interpolate_eff_itn_vector = NULL;
    internal->interpolate_ft = NULL;
    internal->interpolate_int_itn_irs_on = NULL;
    R_Free(internal->age);
    ...
    R_Free(internal->delay_array_cov);
    R_Free(internal->delay_array_cov_);
    ...
    R_Free(internal->irs_vector);
    R_Free(internal->itn_vector);
    R_Free(internal->lagged_cov);
    R_Free(internal->p_det);
    R_Free(internal->phi);
    R_Free(internal->pop_split);
    R_Free(internal->prev0to59);
    R_Free(internal->rel_foi);
    R_Free(internal->t_vector);
    R_Free(internal->w);
    R_Free(internal->w_);
    R_Free(internal->weighted_clin_inc);
    R_Free(internal->whi);
    R_Free(internal->x_I);
    R_Free(internal->Y);
    R_Free(internal->yy);
...
SEXP odin_itn_irs_create(SEXP user) {
  odin_itn_irs_internal *internal = (odin_itn_irs_internal*) R_Calloc(1, odin_itn_irs_internal);
  internal->age = NULL;
  ...
  internal->delay_array_cov = NULL;
  internal->delay_array_cov_ = NULL;
  ...
  internal->irs_vector = NULL;
  internal->itn_vector = NULL;
  internal->lagged_cov = NULL;
  internal->p_det = NULL;
  internal->phi = NULL;
  internal->pop_split = NULL;
  internal->prev0to59 = NULL;
  internal->rel_foi = NULL;
  internal->t_vector = NULL;
  internal->w = NULL;
  internal->w_ = NULL;
  internal->weighted_clin_inc = NULL;
  internal->whi = NULL;
  internal->x_I = NULL;
  internal->Y = NULL;
  internal->yy = NULL;
  ...
  R_Free(internal->delay_index_lagged_cov);
  internal->delay_index_lagged_cov = R_Calloc(0, int);
  R_Free(internal->delay_state_lagged_cov);
  internal->delay_state_lagged_cov = R_Calloc(0, double);
  internal->dim_cov_ = 4;
  internal->dim_w_ = 4;
  internal->dim_yy_ = 4;
  internal->dim_z_ = 4;
  ...
  R_Free(internal->delay_array_cov_);
  internal->delay_array_cov_ = (double*) R_Calloc(internal->dim_cov_, double);
  R_Free(internal->delay_array_w_);
  ...
  R_RegisterCFinalizer(ptr, odin_itn_irs_finalise);
  UNPROTECT(1);
  return ptr;
}
static odin_itn_irs_internal *odin_itn_irs_internal_ds;
void odin_itn_irs_initmod_desolve(void(* odeparms) (int *, double *)) {
  ...
  odin_itn_irs_internal_ds = odin_itn_irs_get_internal(get_desolve_gparms(), 1);
}
SEXP odin_itn_irs_contents(SEXP internal_p) {
  odin_itn_irs_internal *internal = odin_itn_irs_get_internal(internal_p, 1);
  SEXP contents = PROTECT(allocVector(VECSXP, 400));
  ...
  SEXP delay_array_cov = PROTECT(allocVector(REALSXP, internal->dim_cov));
  memcpy(REAL(delay_array_cov), internal->delay_array_cov, internal->dim_cov * sizeof(double));
  SET_VECTOR_ELT(contents, 38, delay_array_cov);
  SEXP delay_array_cov_ = PROTECT(allocVector(REALSXP, internal->dim_cov_));
  memcpy(REAL(delay_array_cov_), internal->delay_array_cov_, internal->dim_cov_ * sizeof(double));
  SET_VECTOR_ELT(contents, 39, delay_array_cov_);
  ...
  SET_VECTOR_ELT(contents, 40, delay_array_EIR);
  ...
  SET_VECTOR_ELT(contents, 41, delay_array_FOI_lag);
  ...
  SET_VECTOR_ELT(contents, 42, delay_array_FOIvijk);
  ...
  SET_VECTOR_ELT(contents, 43, delay_array_p_det);
  ...
  SET_VECTOR_ELT(contents, 44, delay_array_w);
  ...
  SET_VECTOR_ELT(contents, 45, delay_array_w_);
  ...
  SET_VECTOR_ELT(contents, 46, delay_array_whi);
  ...
  SET_VECTOR_ELT(contents, 47, delay_array_yy);
  ...
  SET_VECTOR_ELT(contents, 48, delay_array_yy_);
  ...
  SET_VECTOR_ELT(contents, 49, delay_array_z);
  ...
  SET_VECTOR_ELT(contents, 50, delay_array_z_);
  ...
  SET_VECTOR_ELT(contents, 54, delay_index_incv);
  SEXP delay_index_lagged_cov = PROTECT(allocVector(INTSXP, 0));
  memcpy(INTEGER(delay_index_lagged_cov), internal->delay_index_lagged_cov, 0 * sizeof(int));
  SET_VECTOR_ELT(contents, 55, delay_index_lagged_cov);
  ...
  SET_VECTOR_ELT(contents, 58, delay_state_incv);
  SEXP delay_state_lagged_cov = PROTECT(allocVector(REALSXP, 0));
  memcpy(REAL(delay_state_lagged_cov), internal->delay_state_lagged_cov, 0 * sizeof(double));
  SET_VECTOR_ELT(contents, 59, delay_state_lagged_cov);
  SET_VECTOR_ELT(contents, 60, ScalarReal(internal->delayGam));
  SET_VECTOR_ELT(contents, 61, ScalarReal(internal->delayMos));
  SEXP den = PROTECT(allocVector(REALSXP, internal->dim_den));
  memcpy(REAL(den), internal->den, internal->dim_den * sizeof(double));
  SET_VECTOR_ELT(contents, 62, den);
  SET_VECTOR_ELT(contents, 63, ScalarReal(internal->dID));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_A));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_A_1));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_A_12));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_A_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_A_3));
  ...
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_b));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_b_1));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_b_12));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_b_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_b_3));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_cA));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_cA_1));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_cA_12));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_cA_2));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_cA_3));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_clin_inc));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_clin_inc_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_clin_inc_12));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_clin_inc_2));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_clin_inc_3));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_clin_inc0to5));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_clin_inc0to5_1));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_clin_inc0to5_12));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_clin_inc0to5_2));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_clin_inc0to5_3));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_cov));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_cov_));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_D));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_D_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_D_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_D_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_D_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_delay_FOI));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_delay_FOIv));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_den));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_EIR));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_EIR_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_EIR_12));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_EIR_2));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_EIR_3));
  ...
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_ft_vector));
  ...
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_irs_vector));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_itn_vector));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_lagged_cov));
  ...
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_pop_split));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_prev0to59));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_prev0to59_1));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_prev0to59_12));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_prev0to59_2));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_prev0to59_3));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_rel_foi));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_S_12));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_S_3));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_T_12));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_T_3));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_t_vector));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_U_12));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_U_3));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_w_));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_weighted_clin_inc));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_weighted_clin_inc_1));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_weighted_clin_inc_12));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_weighted_clin_inc_2));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_weighted_clin_inc_3));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_whi));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_x_I));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_Y));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_Y_1));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_Y_12));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_Y_2));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_Y_3));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_yy));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_yy_));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_z));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_z_));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_zhi));
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->dLL));
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->dPL));
  ...
  SET_VECTOR_ELT(contents, 267, EIR);
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->eta));
  SEXP fd = PROTECT(allocVector(REALSXP, internal->dim_fd));
  memcpy(REAL(fd), internal->fd, internal->dim_fd * sizeof(double));
  SET_VECTOR_ELT(contents, 269, fd);
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->fD0));
  ...
  SET_VECTOR_ELT(contents, 271, FOI);
  ...
  SET_VECTOR_ELT(contents, 272, foi_age);
  ...
  SET_VECTOR_ELT(contents, 273, FOI_lag);
  ...
  SET_VECTOR_ELT(contents, 274, FOIvijk);
  SEXP ft_vector = PROTECT(allocVector(REALSXP, internal->dim_ft_vector));
  memcpy(REAL(ft_vector), internal->ft_vector, internal->dim_ft_vector * sizeof(double));
  SET_VECTOR_ELT(contents, 275, ft_vector);
  SET_VECTOR_ELT(contents, 276, ScalarReal(internal->gamma1));
  SET_VECTOR_ELT(contents, 277, ScalarReal(internal->gammaD));
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->gammaL));
  ...
  SET_VECTOR_ELT(contents, 279, het_wt);
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->IB0));
  ...
  SET_VECTOR_ELT(contents, 281, IC);
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->IC0));
  SET_VECTOR_ELT(contents, 283, ScalarReal(internal->ID0));
  ...
  SET_VECTOR_ELT(contents, 284, init_A);
  ...
  SET_VECTOR_ELT(contents, 285, init_D);
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->init_EL));
  SET_VECTOR_ELT(contents, 287, ScalarReal(internal->init_Ev));
  ...
  SET_VECTOR_ELT(contents, 288, init_IB);
  ...
  SET_VECTOR_ELT(contents, 289, init_ICA);
  ...
  SET_VECTOR_ELT(contents, 290, init_ICM);
  ...
  SET_VECTOR_ELT(contents, 291, init_ICM_pre);
  ...
  SET_VECTOR_ELT(contents, 292, init_ID);
  SET_VECTOR_ELT(contents, 293, ScalarReal(internal->init_Iv));
  SET_VECTOR_ELT(contents, 294, ScalarReal(internal->init_LL));
  ...
  SET_VECTOR_ELT(contents, 295, init_P);
  SET_VECTOR_ELT(contents, 296, ScalarReal(internal->init_PL));
  ...
  SET_VECTOR_ELT(contents, 297, init_S);
  SET_VECTOR_ELT(contents, 298, ScalarReal(internal->init_Sv));
  ...
  SET_VECTOR_ELT(contents, 299, init_T);
  ...
  SET_VECTOR_ELT(contents, 300, init_U);
  ...
  SET_VECTOR_ELT(contents, 301, initial_A);
  ...
  SET_VECTOR_ELT(contents, 302, initial_D);
  SET_VECTOR_ELT(contents, 303, ScalarReal(internal->initial_EL));
  SET_VECTOR_ELT(contents, 304, ScalarReal(internal->initial_Ev));
  ...
  SET_VECTOR_ELT(contents, 305, initial_IB);
  ...
  SET_VECTOR_ELT(contents, 306, initial_ICA);
  ...
  SET_VECTOR_ELT(contents, 307, initial_ICM);
  ...
  SET_VECTOR_ELT(contents, 308, initial_ID);
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->initial_Iv));
  SET_VECTOR_ELT(contents, 310, ScalarReal(internal->initial_LL));
  ...
  SET_VECTOR_ELT(contents, 311, initial_P);
  SET_VECTOR_ELT(contents, 312, ScalarReal(internal->initial_PL));
  ...
  SET_VECTOR_ELT(contents, 313, initial_S);
  SET_VECTOR_ELT(contents, 314, ScalarReal(internal->initial_Sv));
  SET_VECTOR_ELT(contents, 315, ScalarReal(internal->initial_t));
  ...
  SET_VECTOR_ELT(contents, 322, ScalarReal(internal->IRS_interval));
  SET_VECTOR_ELT(contents, 323, ScalarReal(internal->irs_loss));
  SEXP irs_vector = PROTECT(allocVector(REALSXP, internal->dim_irs_vector));
  memcpy(REAL(irs_vector), internal->irs_vector, internal->dim_irs_vector * sizeof(double));
  SET_VECTOR_ELT(contents, 324, irs_vector);
  SET_VECTOR_ELT(contents, 325, ScalarReal(internal->ITN_interval));
  SET_VECTOR_ELT(contents, 326, ScalarReal(internal->ITN_IRS_on));
  SET_VECTOR_ELT(contents, 327, ScalarReal(internal->itn_loss));
  SEXP itn_vector = PROTECT(allocVector(REALSXP, internal->dim_itn_vector));
  memcpy(REAL(itn_vector), internal->itn_vector, internal->dim_itn_vector * sizeof(double));
  SET_VECTOR_ELT(contents, 328, itn_vector);
  SET_VECTOR_ELT(contents, 329, ScalarReal(internal->kB));
  SET_VECTOR_ELT(contents, 330, ScalarReal(internal->kC));
  SET_VECTOR_ELT(contents, 331, ScalarReal(internal->kD));
  SEXP lagged_cov = PROTECT(allocVector(REALSXP, internal->dim_lagged_cov));
  memcpy(REAL(lagged_cov), internal->lagged_cov, internal->dim_lagged_cov * sizeof(double));
  SET_VECTOR_ELT(contents, 332, lagged_cov);
  SET_VECTOR_ELT(contents, 333, ScalarReal(internal->mu0));
  SET_VECTOR_ELT(contents, 334, ScalarReal(internal->muEL));
  SET_VECTOR_ELT(contents, 335, ScalarReal(internal->muLL));
  SET_VECTOR_ELT(contents, 336, ScalarReal(internal->muPL));
  SET_VECTOR_ELT(contents, 337, ScalarReal(internal->mv0));
  SET_VECTOR_ELT(contents, 338, ScalarInteger(internal->na));
  SET_VECTOR_ELT(contents, 339, ScalarInteger(internal->nh));
  SET_VECTOR_ELT(contents, 340, ScalarInteger(internal->num_int));
  SET_VECTOR_ELT(contents, 341, ScalarInteger(internal->offset_FOIv_A));
  SET_VECTOR_ELT(contents, 342, ScalarInteger(internal->offset_FOIv_ID));
  SET_VECTOR_ELT(contents, 343, ScalarInteger(internal->offset_FOIv_U));
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 345, ScalarInteger(internal->offset_variable_D));
  SET_VECTOR_ELT(contents, 346, ScalarInteger(internal->offset_variable_IB));
  SET_VECTOR_ELT(contents, 347, ScalarInteger(internal->offset_variable_ICA));
  SET_VECTOR_ELT(contents, 348, ScalarInteger(internal->offset_variable_ICM));
  SET_VECTOR_ELT(contents, 349, ScalarInteger(internal->offset_variable_ID));
  SET_VECTOR_ELT(contents, 350, ScalarInteger(internal->offset_variable_P));
  SET_VECTOR_ELT(contents, 351, ScalarInteger(internal->offset_variable_T));
  SET_VECTOR_ELT(contents, 352, ScalarInteger(internal->offset_variable_U));
  SET_VECTOR_ELT(contents, 353, ScalarReal(internal->omega));
  ...
  SET_VECTOR_ELT(contents, 354, p_det);
  SET_VECTOR_ELT(contents, 355, ScalarReal(internal->p10));
  SET_VECTOR_ELT(contents, 356, ScalarReal(internal->p2));
  ...
  SET_VECTOR_ELT(contents, 357, phi);
  SET_VECTOR_ELT(contents, 358, ScalarReal(internal->phi0));
  SET_VECTOR_ELT(contents, 359, ScalarReal(internal->phi1));
  SET_VECTOR_ELT(contents, 360, ScalarReal(internal->pi));
  SET_VECTOR_ELT(contents, 361, ScalarReal(internal->PM));
  SEXP pop_split = PROTECT(allocVector(REALSXP, internal->dim_pop_split));
  memcpy(REAL(pop_split), internal->pop_split, internal->dim_pop_split * sizeof(double));
  SET_VECTOR_ELT(contents, 362, pop_split);
  ...
  SET_VECTOR_ELT(contents, 363, prev0to59);
  SET_VECTOR_ELT(contents, 364, ScalarReal(internal->Q0));
  SET_VECTOR_ELT(contents, 365, ScalarReal(internal->r_IRS0));
  SET_VECTOR_ELT(contents, 366, ScalarReal(internal->r_ITN0));
  SET_VECTOR_ELT(contents, 367, ScalarReal(internal->r_ITN1));
  SET_VECTOR_ELT(contents, 368, ScalarReal(internal->rA));
  SET_VECTOR_ELT(contents, 369, ScalarReal(internal->rD));
  ...
  SET_VECTOR_ELT(contents, 370, rel_foi);
  SET_VECTOR_ELT(contents, 371, ScalarReal(internal->rP));
  SET_VECTOR_ELT(contents, 372, ScalarReal(internal->rT));
  SET_VECTOR_ELT(contents, 373, ScalarReal(internal->rU));
  SET_VECTOR_ELT(contents, 374, ScalarReal(internal->ssa0));
  SET_VECTOR_ELT(contents, 375, ScalarReal(internal->ssa1));
  SET_VECTOR_ELT(contents, 376, ScalarReal(internal->ssa2));
  SET_VECTOR_ELT(contents, 377, ScalarReal(internal->ssa3));
  SET_VECTOR_ELT(contents, 378, ScalarReal(internal->ssb1));
  SET_VECTOR_ELT(contents, 379, ScalarReal(internal->ssb2));
  SET_VECTOR_ELT(contents, 380, ScalarReal(internal->ssb3));
  SEXP t_vector = PROTECT(allocVector(REALSXP, internal->dim_t_vector));
  memcpy(REAL(t_vector), internal->t_vector, internal->dim_t_vector * sizeof(double));
  SET_VECTOR_ELT(contents, 381, t_vector);
  SET_VECTOR_ELT(contents, 382, ScalarReal(internal->tau1));
  SET_VECTOR_ELT(contents, 383, ScalarReal(internal->tau2));
  SET_VECTOR_ELT(contents, 384, ScalarReal(internal->theta_c));
  SET_VECTOR_ELT(contents, 385, ScalarReal(internal->uB));
  SET_VECTOR_ELT(contents, 386, ScalarReal(internal->uCA));
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->uD));
  SEXP w = PROTECT(allocVector(REALSXP, internal->dim_w));
  memcpy(REAL(w), internal->w, internal->dim_w * sizeof(double));
  SET_VECTOR_ELT(contents, 388, w);
  SEXP w_ = PROTECT(allocVector(REALSXP, internal->dim_w_));
  memcpy(REAL(w_), internal->w_, internal->dim_w_ * sizeof(double));
  SET_VECTOR_ELT(contents, 389, w_);
  SEXP weighted_clin_inc = PROTECT(allocVector(REALSXP, internal->dim_weighted_clin_inc));
  memcpy(REAL(weighted_clin_inc), internal->weighted_clin_inc, internal->dim_weighted_clin_inc * sizeof(double));
  odin_set_dim(weighted_clin_inc, 3, internal->dim_weighted_clin_inc_1, internal->dim_weighted_clin_inc_2, internal->dim_weighted_clin_inc_3);
  SET_VECTOR_ELT(contents, 390, weighted_clin_inc);
  SEXP whi = PROTECT(allocVector(REALSXP, internal->dim_whi));
  memcpy(REAL(whi), internal->whi, internal->dim_whi * sizeof(double));
  SET_VECTOR_ELT(contents, 391, whi);
  SEXP x_I = PROTECT(allocVector(REALSXP, internal->dim_x_I));
  memcpy(REAL(x_I), internal->x_I, internal->dim_x_I * sizeof(double));
  SET_VECTOR_ELT(contents, 392, x_I);
  ...
  SET_STRING_ELT(nms, 38, mkChar("delay_array_cov"));
  SET_STRING_ELT(nms, 39, mkChar("delay_array_cov_"));
  SET_STRING_ELT(nms, 40, mkChar("delay_array_EIR"));
  SET_STRING_ELT(nms, 41, mkChar("delay_array_FOI_lag"));
  SET_STRING_ELT(nms, 42, mkChar("delay_array_FOIvijk"));
  SET_STRING_ELT(nms, 43, mkChar("delay_array_p_det"));
  SET_STRING_ELT(nms, 44, mkChar("delay_array_w"));
  SET_STRING_ELT(nms, 45, mkChar("delay_array_w_"));
  SET_STRING_ELT(nms, 46, mkChar("delay_array_whi"));
  SET_STRING_ELT(nms, 47, mkChar("delay_array_yy"));
  SET_STRING_ELT(nms, 48, mkChar("delay_array_yy_"));
  SET_STRING_ELT(nms, 49, mkChar("delay_array_z"));
  SET_STRING_ELT(nms, 50, mkChar("delay_array_z_"));
  ...
  SET_STRING_ELT(nms, 54, mkChar("delay_index_incv"));
  SET_STRING_ELT(nms, 55, mkChar("delay_index_lagged_cov"));
  SET_STRING_ELT(nms, 56, mkChar("delay_state_FOI"));
  SET_STRING_ELT(nms, 57, mkChar("delay_state_FOIv"));
  SET_STRING_ELT(nms, 58, mkChar("delay_state_incv"));
  SET_STRING_ELT(nms, 59, mkChar("delay_state_lagged_cov"));
  SET_STRING_ELT(nms, 60, mkChar("delayGam"));
  SET_STRING_ELT(nms, 61, mkChar("delayMos"));
  SET_STRING_ELT(nms, 62, mkChar("den"));
  SET_STRING_ELT(nms, 63, mkChar("dID"));
  SET_STRING_ELT(nms, 64, mkChar("dim_A"));
  SET_STRING_ELT(nms, 65, mkChar("dim_A_1"));
  SET_STRING_ELT(nms, 66, mkChar("dim_A_12"));
  SET_STRING_ELT(nms, 67, mkChar("dim_A_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_A_3"));
  ...
  SET_STRING_ELT(nms, 73, mkChar("dim_b"));
  SET_STRING_ELT(nms, 74, mkChar("dim_b_1"));
  SET_STRING_ELT(nms, 75, mkChar("dim_b_12"));
  SET_STRING_ELT(nms, 76, mkChar("dim_b_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_b_3"));
  SET_STRING_ELT(nms, 78, mkChar("dim_cA"));
  SET_STRING_ELT(nms, 79, mkChar("dim_cA_1"));
  SET_STRING_ELT(nms, 80, mkChar("dim_cA_12"));
  SET_STRING_ELT(nms, 81, mkChar("dim_cA_2"));
  SET_STRING_ELT(nms, 82, mkChar("dim_cA_3"));
  SET_STRING_ELT(nms, 83, mkChar("dim_clin_inc"));
  SET_STRING_ELT(nms, 84, mkChar("dim_clin_inc_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_clin_inc_12"));
  SET_STRING_ELT(nms, 86, mkChar("dim_clin_inc_2"));
  SET_STRING_ELT(nms, 87, mkChar("dim_clin_inc_3"));
  SET_STRING_ELT(nms, 88, mkChar("dim_clin_inc0to5"));
  SET_STRING_ELT(nms, 89, mkChar("dim_clin_inc0to5_1"));
  SET_STRING_ELT(nms, 90, mkChar("dim_clin_inc0to5_12"));
  SET_STRING_ELT(nms, 91, mkChar("dim_clin_inc0to5_2"));
  SET_STRING_ELT(nms, 92, mkChar("dim_clin_inc0to5_3"));
  SET_STRING_ELT(nms, 93, mkChar("dim_cov"));
  SET_STRING_ELT(nms, 94, mkChar("dim_cov_"));
  SET_STRING_ELT(nms, 95, mkChar("dim_D"));
  SET_STRING_ELT(nms, 96, mkChar("dim_D_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_D_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_D_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_D_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_delay_FOI"));
  SET_STRING_ELT(nms, 101, mkChar("dim_delay_FOIv"));
  SET_STRING_ELT(nms, 102, mkChar("dim_den"));
  SET_STRING_ELT(nms, 103, mkChar("dim_EIR"));
  SET_STRING_ELT(nms, 104, mkChar("dim_EIR_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_EIR_12"));
  SET_STRING_ELT(nms, 106, mkChar("dim_EIR_2"));
  SET_STRING_ELT(nms, 107, mkChar("dim_EIR_3"));
  ...
  SET_STRING_ELT(nms, 125, mkChar("dim_ft_vector"));
  ...
  SET_STRING_ELT(nms, 205, mkChar("dim_irs_vector"));
  SET_STRING_ELT(nms, 206, mkChar("dim_itn_vector"));
  SET_STRING_ELT(nms, 207, mkChar("dim_lagged_cov"));
  ...
  SET_STRING_ELT(nms, 223, mkChar("dim_pop_split"));
  SET_STRING_ELT(nms, 224, mkChar("dim_prev0to59"));
  SET_STRING_ELT(nms, 225, mkChar("dim_prev0to59_1"));
  SET_STRING_ELT(nms, 226, mkChar("dim_prev0to59_12"));
  SET_STRING_ELT(nms, 227, mkChar("dim_prev0to59_2"));
  SET_STRING_ELT(nms, 228, mkChar("dim_prev0to59_3"));
  SET_STRING_ELT(nms, 229, mkChar("dim_rel_foi"));
  SET_STRING_ELT(nms, 230, mkChar("dim_S"));
  SET_STRING_ELT(nms, 231, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 232, mkChar("dim_S_12"));
  SET_STRING_ELT(nms, 233, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 234, mkChar("dim_S_3"));
  SET_STRING_ELT(nms, 235, mkChar("dim_T"));
  SET_STRING_ELT(nms, 236, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 237, mkChar("dim_T_12"));
  SET_STRING_ELT(nms, 238, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 239, mkChar("dim_T_3"));
  SET_STRING_ELT(nms, 240, mkChar("dim_t_vector"));
  SET_STRING_ELT(nms, 241, mkChar("dim_U"));
  SET_STRING_ELT(nms, 242, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 243, mkChar("dim_U_12"));
  SET_STRING_ELT(nms, 244, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 245, mkChar("dim_U_3"));
  SET_STRING_ELT(nms, 246, mkChar("dim_w"));
  SET_STRING_ELT(nms, 247, mkChar("dim_w_"));
  SET_STRING_ELT(nms, 248, mkChar("dim_weighted_clin_inc"));
  SET_STRING_ELT(nms, 249, mkChar("dim_weighted_clin_inc_1"));
  SET_STRING_ELT(nms, 250, mkChar("dim_weighted_clin_inc_12"));
  SET_STRING_ELT(nms, 251, mkChar("dim_weighted_clin_inc_2"));
  SET_STRING_ELT(nms, 252, mkChar("dim_weighted_clin_inc_3"));
  SET_STRING_ELT(nms, 253, mkChar("dim_whi"));
  SET_STRING_ELT(nms, 254, mkChar("dim_x_I"));
  SET_STRING_ELT(nms, 255, mkChar("dim_Y"));
  SET_STRING_ELT(nms, 256, mkChar("dim_Y_1"));
  SET_STRING_ELT(nms, 257, mkChar("dim_Y_12"));
  SET_STRING_ELT(nms, 258, mkChar("dim_Y_2"));
  SET_STRING_ELT(nms, 259, mkChar("dim_Y_3"));
  SET_STRING_ELT(nms, 260, mkChar("dim_yy"));
  SET_STRING_ELT(nms, 261, mkChar("dim_yy_"));
  SET_STRING_ELT(nms, 262, mkChar("dim_z"));
  SET_STRING_ELT(nms, 263, mkChar("dim_z_"));
  SET_STRING_ELT(nms, 264, mkChar("dim_zhi"));
  SET_STRING_ELT(nms, 265, mkChar("dLL"));
  SET_STRING_ELT(nms, 266, mkChar("dPL"));
  SET_STRING_ELT(nms, 267, mkChar("EIR"));
  SET_STRING_ELT(nms, 268, mkChar("eta"));
  SET_STRING_ELT(nms, 269, mkChar("fd"));
  SET_STRING_ELT(nms, 270, mkChar("fD0"));
  SET_STRING_ELT(nms, 271, mkChar("FOI"));
  SET_STRING_ELT(nms, 272, mkChar("foi_age"));
  SET_STRING_ELT(nms, 273, mkChar("FOI_lag"));
  SET_STRING_ELT(nms, 274, mkChar("FOIvijk"));
  SET_STRING_ELT(nms, 275, mkChar("ft_vector"));
  SET_STRING_ELT(nms, 276, mkChar("gamma1"));
  SET_STRING_ELT(nms, 277, mkChar("gammaD"));
  SET_STRING_ELT(nms, 278, mkChar("gammaL"));
  SET_STRING_ELT(nms, 279, mkChar("het_wt"));
  SET_STRING_ELT(nms, 280, mkChar("IB0"));
  SET_STRING_ELT(nms, 281, mkChar("IC"));
  SET_STRING_ELT(nms, 282, mkChar("IC0"));
  SET_STRING_ELT(nms, 283, mkChar("ID0"));
  SET_STRING_ELT(nms, 284, mkChar("init_A"));
  SET_STRING_ELT(nms, 285, mkChar("init_D"));
  SET_STRING_ELT(nms, 286, mkChar("init_EL"));
  SET_STRING_ELT(nms, 287, mkChar("init_Ev"));
  SET_STRING_ELT(nms, 288, mkChar("init_IB"));
  SET_STRING_ELT(nms, 289, mkChar("init_ICA"));
  SET_STRING_ELT(nms, 290, mkChar("init_ICM"));
  SET_STRING_ELT(nms, 291, mkChar("init_ICM_pre"));
  SET_STRING_ELT(nms, 292, mkChar("init_ID"));
  SET_STRING_ELT(nms, 293, mkChar("init_Iv"));
  SET_STRING_ELT(nms, 294, mkChar("init_LL"));
  SET_STRING_ELT(nms, 295, mkChar("init_P"));
  SET_STRING_ELT(nms, 296, mkChar("init_PL"));
  SET_STRING_ELT(nms, 297, mkChar("init_S"));
  SET_STRING_ELT(nms, 298, mkChar("init_Sv"));
  SET_STRING_ELT(nms, 299, mkChar("init_T"));
  SET_STRING_ELT(nms, 300, mkChar("init_U"));
  SET_STRING_ELT(nms, 301, mkChar("initial_A"));
  SET_STRING_ELT(nms, 302, mkChar("initial_D"));
  SET_STRING_ELT(nms, 303, mkChar("initial_EL"));
  SET_STRING_ELT(nms, 304, mkChar("initial_Ev"));
  SET_STRING_ELT(nms, 305, mkChar("initial_IB"));
  SET_STRING_ELT(nms, 306, mkChar("initial_ICA"));
  SET_STRING_ELT(nms, 307, mkChar("initial_ICM"));
  SET_STRING_ELT(nms, 308, mkChar("initial_ID"));
  SET_STRING_ELT(nms, 309, mkChar("initial_Iv"));
  SET_STRING_ELT(nms, 310, mkChar("initial_LL"));
  SET_STRING_ELT(nms, 311, mkChar("initial_P"));
  SET_STRING_ELT(nms, 312, mkChar("initial_PL"));
  SET_STRING_ELT(nms, 313, mkChar("initial_S"));
  SET_STRING_ELT(nms, 314, mkChar("initial_Sv"));
  SET_STRING_ELT(nms, 315, mkChar("initial_t"));
  SET_STRING_ELT(nms, 316, mkChar("initial_T"));
  SET_STRING_ELT(nms, 317, mkChar("initial_U"));
  SET_STRING_ELT(nms, 318, mkChar("interpolate_eff_irs_vector"));
  SET_STRING_ELT(nms, 319, mkChar("interpolate_eff_itn_vector"));
  SET_STRING_ELT(nms, 320, mkChar("interpolate_ft"));
  SET_STRING_ELT(nms, 321, mkChar("interpolate_int_itn_irs_on"));
  SET_STRING_ELT(nms, 322, mkChar("IRS_interval"));
  SET_STRING_ELT(nms, 323, mkChar("irs_loss"));
  SET_STRING_ELT(nms, 324, mkChar("irs_vector"));
  SET_STRING_ELT(nms, 325, mkChar("ITN_interval"));
  SET_STRING_ELT(nms, 326, mkChar("ITN_IRS_on"));
  SET_STRING_ELT(nms, 327, mkChar("itn_loss"));
  SET_STRING_ELT(nms, 328, mkChar("itn_vector"));
  SET_STRING_ELT(nms, 329, mkChar("kB"));
  SET_STRING_ELT(nms, 330, mkChar("kC"));
  SET_STRING_ELT(nms, 331, mkChar("kD"));
  SET_STRING_ELT(nms, 332, mkChar("lagged_cov"));
  SET_STRING_ELT(nms, 333, mkChar("mu0"));
  SET_STRING_ELT(nms, 334, mkChar("muEL"));
  SET_STRING_ELT(nms, 335, mkChar("muLL"));
  SET_STRING_ELT(nms, 336, mkChar("muPL"));
  SET_STRING_ELT(nms, 337, mkChar("mv0"));
  SET_STRING_ELT(nms, 338, mkChar("na"));
  SET_STRING_ELT(nms, 339, mkChar("nh"));
  SET_STRING_ELT(nms, 340, mkChar("num_int"));
  SET_STRING_ELT(nms, 341, mkChar("offset_FOIv_A"));
  SET_STRING_ELT(nms, 342, mkChar("offset_FOIv_ID"));
  SET_STRING_ELT(nms, 343, mkChar("offset_FOIv_U"));
  SET_STRING_ELT(nms, 344, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 345, mkChar("offset_variable_D"));
  SET_STRING_ELT(nms, 346, mkChar("offset_variable_IB"));
  SET_STRING_ELT(nms, 347, mkChar("offset_variable_ICA"));
  SET_STRING_ELT(nms, 348, mkChar("offset_variable_ICM"));
  SET_STRING_ELT(nms, 349, mkChar("offset_variable_ID"));
  SET_STRING_ELT(nms, 350, mkChar("offset_variable_P"));
  SET_STRING_ELT(nms, 351, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 352, mkChar("offset_variable_U"));
  SET_STRING_ELT(nms, 353, mkChar("omega"));
  SET_STRING_ELT(nms, 354, mkChar("p_det"));
  SET_STRING_ELT(nms, 355, mkChar("p10"));
  SET_STRING_ELT(nms, 356, mkChar("p2"));
  SET_STRING_ELT(nms, 357, mkChar("phi"));
  SET_STRING_ELT(nms, 358, mkChar("phi0"));
  SET_STRING_ELT(nms, 359, mkChar("phi1"));
  SET_STRING_ELT(nms, 360, mkChar("pi"));
  SET_STRING_ELT(nms, 361, mkChar("PM"));
  SET_STRING_ELT(nms, 362, mkChar("pop_split"));
  SET_STRING_ELT(nms, 363, mkChar("prev0to59"));
  SET_STRING_ELT(nms, 364, mkChar("Q0"));
  SET_STRING_ELT(nms, 365, mkChar("r_IRS0"));
  SET_STRING_ELT(nms, 366, mkChar("r_ITN0"));
  SET_STRING_ELT(nms, 367, mkChar("r_ITN1"));
  SET_STRING_ELT(nms, 368, mkChar("rA"));
  SET_STRING_ELT(nms, 369, mkChar("rD"));
  SET_STRING_ELT(nms, 370, mkChar("rel_foi"));
  SET_STRING_ELT(nms, 371, mkChar("rP"));
  SET_STRING_ELT(nms, 372, mkChar("rT"));
  SET_STRING_ELT(nms, 373, mkChar("rU"));
  SET_STRING_ELT(nms, 374, mkChar("ssa0"));
  SET_STRING_ELT(nms, 375, mkChar("ssa1"));
  SET_STRING_ELT(nms, 376, mkChar("ssa2"));
  SET_STRING_ELT(nms, 377, mkChar("ssa3"));
  SET_STRING_ELT(nms, 378, mkChar("ssb1"));
  SET_STRING_ELT(nms, 379, mkChar("ssb2"));
  SET_STRING_ELT(nms, 380, mkChar("ssb3"));
  SET_STRING_ELT(nms, 381, mkChar("t_vector"));
  SET_STRING_ELT(nms, 382, mkChar("tau1"));
  SET_STRING_ELT(nms, 383, mkChar("tau2"));
  SET_STRING_ELT(nms, 384, mkChar("theta_c"));
  SET_STRING_ELT(nms, 385, mkChar("uB"));
  SET_STRING_ELT(nms, 386, mkChar("uCA"));
  SET_STRING_ELT(nms, 387, mkChar("uD"));
  SET_STRING_ELT(nms, 388, mkChar("w"));
  SET_STRING_ELT(nms, 389, mkChar("w_"));
  SET_STRING_ELT(nms, 390, mkChar("weighted_clin_inc"));
  SET_STRING_ELT(nms, 391, mkChar("whi"));
  SET_STRING_ELT(nms, 392, mkChar("x_I"));
  SET_STRING_ELT(nms, 393, mkChar("Y"));
  SET_STRING_ELT(nms, 394, mkChar("yy"));
  SET_STRING_ELT(nms, 395, mkChar("yy_"));
  SET_STRING_ELT(nms, 396, mkChar("z"));
  SET_STRING_ELT(nms, 397, mkChar("z_"));
  SET_STRING_ELT(nms, 398, mkChar("zhi"));
  SET_STRING_ELT(nms, 399, mkChar("odin_itn_irs_use_dde"));
...
SEXP odin_itn_irs_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->ft_vector = (double*) user_get_array_dim(user, false, internal->ft_vector, "ft_vector", 1, NA_REAL, NA_REAL, &internal->dim_ft_vector);
  ...
  internal->irs_vector = (double*) user_get_array_dim(user, false, internal->irs_vector, "irs_vector", 1, NA_REAL, NA_REAL, &internal->dim_irs_vector);
  ...
  internal->itn_vector = (double*) user_get_array_dim(user, false, internal->itn_vector, "itn_vector", 1, NA_REAL, NA_REAL, &internal->dim_itn_vector);
  ...
  internal->dim_lagged_cov = internal->num_int;
  ...
  internal->dim_pop_split = internal->num_int;
  ...
  internal->dim_weighted_clin_inc_1 = internal->na;
  internal->dim_weighted_clin_inc_2 = internal->nh;
  internal->dim_weighted_clin_inc_3 = internal->num_int;
  ...
  R_Free(internal->lagged_cov);
  internal->lagged_cov = (double*) R_Calloc(internal->dim_lagged_cov, double);
  R_Free(internal->w);
  ...
  R_Free(internal->delay_array_cov);
  internal->delay_array_cov = (double*) R_Calloc(internal->dim_cov, double);
  R_Free(internal->delay_array_w);
  ...
  internal->dim_t_vector = internal->dim_itn_vector;
  internal->dim_U = internal->dim_U_1 * internal->dim_U_2 * internal->dim_U_3;
  internal->dim_U_12 = internal->dim_U_1 * internal->dim_U_2;
  internal->dim_weighted_clin_inc = internal->dim_weighted_clin_inc_1 * internal->dim_weighted_clin_inc_2 * internal->dim_weighted_clin_inc_3;
  internal->dim_weighted_clin_inc_12 = internal->dim_weighted_clin_inc_1 * internal->dim_weighted_clin_inc_2;
  ...
  internal->pop_split = (double*) user_get_array(user, false, internal->pop_split, "pop_split", NA_REAL, NA_REAL, 1, internal->dim_pop_split);
  ...
  R_Free(internal->weighted_clin_inc);
  internal->weighted_clin_inc = (double*) R_Calloc(internal->dim_weighted_clin_inc, double);
  R_Free(internal->Y);
  ...
  internal->t_vector = (double*) user_get_array(user, false, internal->t_vector, "t_vector", NA_REAL, NA_REAL, 1, internal->dim_t_vector);
  R_Free(internal->delay_index_FOI);
  ...
  interpolate_check_y(internal->dim_t_vector, internal->dim_irs_vector, 0, "irs_vector", "eff_irs_vector");
  cinterpolate_free(internal->interpolate_eff_irs_vector);
  internal->interpolate_eff_irs_vector = cinterpolate_alloc("constant", internal->dim_t_vector, 1, internal->t_vector, internal->irs_vector, true, false);
  interpolate_check_y(internal->dim_t_vector, internal->dim_itn_vector, 0, "itn_vector", "eff_itn_vector");
  cinterpolate_free(internal->interpolate_eff_itn_vector);
  internal->interpolate_eff_itn_vector = cinterpolate_alloc("constant", internal->dim_t_vector, 1, internal->t_vector, internal->itn_vector, true, false);
  interpolate_check_y(internal->dim_t_vector, internal->dim_ft_vector, 0, "ft_vector", "ft");
  cinterpolate_free(internal->interpolate_ft);
  internal->interpolate_ft = cinterpolate_alloc("constant", internal->dim_t_vector, 1, internal->t_vector, internal->ft_vector, true, false);
  interpolate_check_y(internal->dim_t_vector, internal->dim_t_vector, 0, "t_vector", "int_itn_irs_on");
  cinterpolate_free(internal->interpolate_int_itn_irs_on);
  internal->interpolate_int_itn_irs_on = cinterpolate_alloc("constant", internal->dim_t_vector, 1, internal->t_vector, internal->t_vector, true, false);
  return R_NilValue;
}
SEXP odin_itn_irs_set_initial(SEXP internal_p, SEXP t_ptr, SEXP state_ptr, SEXP odin_itn_irs_use_dde_ptr) {
  odin_itn_irs_internal *internal = odin_itn_irs_get_internal(internal_p, 1);
  ...
  internal->odin_itn_irs_use_dde = INTEGER(odin_itn_irs_use_dde_ptr)[0];
...
SEXP odin_itn_irs_metadata(SEXP internal_p) {
  ...
  UNPROTECT(2);
  SEXP output_length = PROTECT(allocVector(VECSXP, 28));
  SEXP output_names = PROTECT(allocVector(STRSXP, 28));
  ...
  SET_VECTOR_ELT(output_length, 27, ScalarInteger(internal->dim_cov));
  ...
  SET_STRING_ELT(output_names, 7, mkChar("prev1"));
  SET_STRING_ELT(output_names, 8, mkChar("prev2"));
  ...
  SET_STRING_ELT(output_names, 12, mkChar("fv"));
  SET_STRING_ELT(output_names, 13, mkChar("beta_larval"));
  SET_STRING_ELT(output_names, 14, mkChar("KL"));
  SET_STRING_ELT(output_names, 15, mkChar("mv"));
  SET_STRING_ELT(output_names, 16, mkChar("Q"));
  SET_STRING_ELT(output_names, 17, mkChar("wh"));
  SET_STRING_ELT(output_names, 18, mkChar("d_ITN"));
  SET_STRING_ELT(output_names, 19, mkChar("r_ITN"));
  SET_STRING_ELT(output_names, 20, mkChar("s_ITN"));
  SET_STRING_ELT(output_names, 21, mkChar("d_IRS"));
  SET_STRING_ELT(output_names, 22, mkChar("r_IRS"));
  SET_STRING_ELT(output_names, 23, mkChar("s_IRS"));
  SET_STRING_ELT(output_names, 24, mkChar("ft"));
  SET_STRING_ELT(output_names, 25, mkChar("K0"));
  SET_STRING_ELT(output_names, 26, mkChar("av"));
  SET_STRING_ELT(output_names, 27, mkChar("cov"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_cov + 27));
  ...
  SET_VECTOR_ELT(interpolate_t, 0, ScalarReal(internal->t_vector[0]));
...
void odin_itn_irs_rhs(odin_itn_irs_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double incv;
  {
    ...
    if (t <= internal->initial_t) {
      ...
      lagvalue(t, internal->odin_itn_irs_use_dde, internal->delay_index_incv, 1, internal->delay_state_incv);
    ...
    double FOIv;
    {
      ...
      if (t <= internal->initial_t) {
        ...
        lagvalue(t, internal->odin_itn_irs_use_dde, internal->delay_index_FOIv, internal->dim_delay_FOIv, internal->delay_state_FOIv);
      ...
      double eff_itn_vector = 0.0;
      cinterpolate_eval(t, internal->interpolate_eff_itn_vector, &eff_itn_vector);
      double eff_irs_vector = 0.0;
      cinterpolate_eval(t, internal->interpolate_eff_irs_vector, &eff_irs_vector);
      double int_itn_irs_on = 0.0;
      cinterpolate_eval(t, internal->interpolate_int_itn_irs_on, &int_itn_irs_on);
      {
         int i = 1;
         internal->delay_array_cov_[i - 1] = (1 - eff_itn_vector) * (1 - eff_irs_vector);
      }
      {
         int i = 2;
         internal->delay_array_cov_[i - 1] = eff_itn_vector * (1 - eff_irs_vector);
      }
      {
         int i = 3;
         internal->delay_array_cov_[i - 1] = (1 - eff_itn_vector) * eff_irs_vector;
      }
      {
         int i = 4;
         internal->delay_array_cov_[i - 1] = eff_itn_vector * eff_irs_vector;
      }
      double eff_ITN_IRS_on = (t < internal->ITN_IRS_on ? internal->ITN_IRS_on : int_itn_irs_on);
      for (int i = 1; i <= internal->dim_cov; ++i) {
        internal->delay_array_cov[i - 1] = internal->delay_array_cov_[i - 1];
      }
      double IRS_decay = (t < internal->ITN_IRS_on ? 0 : exp(-((fmodr((t - eff_ITN_IRS_on), internal->IRS_interval))) * internal->irs_loss));
      double ITN_decay = (t < internal->ITN_IRS_on ? 0 : exp(-((fmodr((t - eff_ITN_IRS_on), internal->ITN_interval))) * internal->itn_loss));
      ...
      for (int i = 1; i <= internal->num_int; ++i) {
        internal->delay_array_zhi[i - 1] = internal->delay_array_cov[i - 1] * internal->delay_array_z[i - 1];
      }
      for (int i = 1; i <= internal->num_int; ++i) {
        internal->delay_array_whi[i - 1] = internal->delay_array_cov[i - 1] * internal->delay_array_w[i - 1];
      }
      ...
      for (int i = 1; i <= internal->na; ++i) {
        for (int j = 1; j <= internal->nh; ++j) {
          for (int k = 1; k <= internal->num_int; ++k) {
            internal->delay_array_FOIvijk[i - 1 + internal->dim_FOIvijk_1 * (j - 1) + internal->dim_FOIvijk_12 * (k - 1)] = (internal->cT * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] + internal->cD * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] + internal->delay_array_cA[internal->dim_cA_12 * (k - 1) + internal->dim_cA_1 * (j - 1) + i - 1] * A[internal->dim_A_12 * (k - 1) + internal->dim_A_1 * (j - 1) + i - 1] + internal->cU * U[internal->dim_U_12 * (k - 1) + internal->dim_U_1 * (j - 1) + i - 1]) * internal->rel_foi[j - 1] * internal->delay_array_av_mosq[k - 1] * internal->foi_age[i - 1] / (double) internal->omega * internal->delay_array_cov[k - 1] / (double) internal->pop_split[k - 1];
          }
        }
      }
  ...
  // delay block for FOI
  {
    ...
    if (t <= internal->initial_t) {
      ...
      lagvalue(t, internal->odin_itn_irs_use_dde, internal->delay_index_FOI, internal->dim_delay_FOI, internal->delay_state_FOI);
    ...
    {
       int i = 2;
       internal->delay_array_yy_[i - 1] = internal->delay_array_w[1];
    }
    {
       int i = 3;
  ...
  }
  {
     ...
     for (int j = 1; j <= internal->nh; ++j) {
       for (int k = 1; k <= internal->num_int; ++k) {
         dstatedt[6 + i - 1 + internal->dim_S_1 * (j - 1) + internal->dim_S_12 * (k - 1)] = -(internal->FOI[internal->dim_FOI_12 * (k - 1) + internal->dim_FOI_1 * (j - 1) + i - 1]) * S[internal->dim_S_12 * (k - 1) + internal->dim_S_1 * (j - 1) + i - 1] + internal->rP * P[internal->dim_P_12 * (k - 1) + internal->dim_P_1 * (j - 1) + i - 1] + internal->rU * U[internal->dim_U_12 * (k - 1) + internal->dim_U_1 * (j - 1) + i - 1] + internal->pop_split[k - 1] * internal->eta * H * internal->het_wt[j - 1] - (internal->eta + internal->age_rate[i - 1]) * S[internal->dim_S_12 * (k - 1) + internal->dim_S_1 * (j - 1) + i - 1];
       }
     }
  }
  for (int i = 2; i <= internal->na; ++i) {
  ...
  cinterpolate_eval(t, internal->interpolate_eff_itn_vector, &eff_itn_vector);
  double ft = 0.0;
  cinterpolate_eval(t, internal->interpolate_ft, &ft);
  double ince = FOIv * Sv;
  double int_itn_irs_on = 0.0;
  cinterpolate_eval(t, internal->interpolate_int_itn_irs_on, &int_itn_irs_on);
  for (int i = 1; i <= internal->na; ++i) {
  ...
  {
     int i = 1;
     internal->cov_[i - 1] = (1 - eff_itn_vector) * (1 - eff_irs_vector);
  }
  {
     int i = 2;
     internal->cov_[i - 1] = eff_itn_vector * (1 - eff_irs_vector);
  }
  {
     int i = 3;
     internal->cov_[i - 1] = (1 - eff_itn_vector) * eff_irs_vector;
  }
  {
     int i = 4;
     internal->cov_[i - 1] = eff_itn_vector * eff_irs_vector;
  }
  {
     int i = 1;
     for (int j = 1; j <= internal->nh; ++j) {
  ...
  }
  {
     ...
     for (int j = 1; j <= internal->nh; ++j) {
       for (int k = 1; k <= internal->num_int; ++k) {
         dstatedt[internal->offset_variable_D + i - 1 + internal->dim_D_1 * (j - 1) + internal->dim_D_12 * (k - 1)] = (1 - ft) * internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1] - internal->rD * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] - (internal->eta + internal->age_rate[i - 1]) * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1];
       }
     }
  }
  for (int i = 2; i <= internal->na; ++i) {
    for (int j = 1; j <= internal->nh; ++j) {
      for (int k = 1; k <= internal->num_int; ++k) {
        dstatedt[internal->offset_variable_D + i - 1 + internal->dim_D_1 * (j - 1) + internal->dim_D_12 * (k - 1)] = (1 - ft) * internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1] - internal->rD * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] - (internal->eta + internal->age_rate[i - 1]) * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] + internal->age_rate[i - 1 - 1] * D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1 - 1];
      }
    }
  }
  {
     ...
     for (int j = 1; j <= internal->nh; ++j) {
       for (int k = 1; k <= internal->num_int; ++k) {
         dstatedt[internal->offset_variable_T + i - 1 + internal->dim_T_1 * (j - 1) + internal->dim_T_12 * (k - 1)] = ft * internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1] - internal->rT * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] - (internal->eta + internal->age_rate[i - 1]) * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1];
       }
     }
  }
  for (int i = 2; i <= internal->na; ++i) {
    for (int j = 1; j <= internal->nh; ++j) {
      for (int k = 1; k <= internal->num_int; ++k) {
        dstatedt[internal->offset_variable_T + i - 1 + internal->dim_T_1 * (j - 1) + internal->dim_T_12 * (k - 1)] = ft * internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1] - internal->rT * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] - (internal->eta + internal->age_rate[i - 1]) * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] + internal->age_rate[i - 1 - 1] * T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1 - 1];
      }
    }
  }
  double IRS_decay = (t < internal->ITN_IRS_on ? 0 : exp(-((fmodr((t - eff_ITN_IRS_on), internal->IRS_interval))) * internal->irs_loss));
  ...
  if (output) {
    ...
    // delay block for lagged_cov
    {
      ...
      for (int i = 1; i <= internal->dim_lagged_cov; ++i) {
        internal->lagged_cov[i - 1] = internal->delay_array_cov[i - 1];
      }
    }
    ...
    for (int i = 1; i <= internal->age59; ++i) {
      for (int j = 1; j <= internal->dim_prev0to59_2; ++j) {
        for (int k = 1; k <= internal->dim_prev0to59_3; ++k) {
          internal->prev0to59[i - 1 + internal->dim_prev0to59_1 * (j - 1) + internal->dim_prev0to59_12 * (k - 1)] = T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] * internal->lagged_cov[k - 1] / (double) internal->pop_split[k - 1] + D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] * internal->lagged_cov[k - 1] / (double) internal->pop_split[k - 1] + A[internal->dim_A_12 * (k - 1) + internal->dim_A_1 * (j - 1) + i - 1] * internal->lagged_cov[k - 1] / (double) internal->pop_split[k - 1] * internal->p_det[internal->dim_p_det_12 * (k - 1) + internal->dim_p_det_1 * (j - 1) + i - 1];
        }
      }
    }
    output[24] = ft;
    ...
    output[7] = odin_sum3(internal->prev0to59, 0, internal->dim_prev0to59_1, 0, internal->dim_prev0to59_2, 0, 1, internal->dim_prev0to59_1, internal->dim_prev0to59_12) / (double) (odin_sum1(internal->den, 0, internal->age59) * internal->lagged_cov[0]);
    output[8] = odin_sum3(internal->prev0to59, 0, internal->dim_prev0to59_1, 0, internal->dim_prev0to59_2, 1, 2, internal->dim_prev0to59_1, internal->dim_prev0to59_12) / (double) (odin_sum1(internal->den, 0, internal->age59) * internal->lagged_cov[1]);
    for (int i = 1; i <= internal->dim_weighted_clin_inc_1; ++i) {
      for (int j = 1; j <= internal->dim_weighted_clin_inc_2; ++j) {
        for (int k = 1; k <= internal->dim_weighted_clin_inc_3; ++k) {
          internal->weighted_clin_inc[i - 1 + internal->dim_weighted_clin_inc_1 * (j - 1) + internal->dim_weighted_clin_inc_12 * (k - 1)] = internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1] * internal->lagged_cov[k - 1] / (double) internal->pop_split[k - 1];
        }
      }
    }
    for (int i = 1; i <= internal->age05; ++i) {
      for (int j = 1; j <= internal->dim_clin_inc0to5_2; ++j) {
        for (int k = 1; k <= internal->dim_clin_inc0to5_3; ++k) {
          internal->clin_inc0to5[i - 1 + internal->dim_clin_inc0to5_1 * (j - 1) + internal->dim_clin_inc0to5_12 * (k - 1)] = internal->weighted_clin_inc[internal->dim_weighted_clin_inc_12 * (k - 1) + internal->dim_weighted_clin_inc_1 * (j - 1) + i - 1];
        }
      }
    }
    memcpy(output + 27, internal->cov, internal->dim_cov * sizeof(double));
    output[10] = odin_sum3(internal->weighted_clin_inc, 0, internal->dim_weighted_clin_inc_1, 0, internal->dim_weighted_clin_inc_2, 0, internal->dim_weighted_clin_inc_3, internal->dim_weighted_clin_inc_1, internal->dim_weighted_clin_inc_12);
    output[21] = d_IRS;
    output[18] = d_ITN;
    ...
    output[26] = av;
    output[11] = mu;
    output[13] = beta_larval;
    output[25] = K0;
    output[14] = KL;
  }
}
void odin_itn_irs_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
  odin_itn_irs_rhs((odin_itn_irs_internal*)internal, t, state, dstatedt, NULL);
}
void odin_itn_irs_rhs_desolve(int * neq, double * t, double * state, double * dstatedt, double * output, int * np) {
  odin_itn_irs_rhs(odin_itn_irs_internal_ds, *t, state, dstatedt, output);
}
void odin_itn_irs_output_dde(size_t n_eq, double t, double * state, size_t n_output, double * output, void * internal_p) {
  odin_itn_irs_internal *internal = (odin_itn_irs_internal*) internal_p;
  double * S = state + 6;
  double * T = state + internal->offset_variable_T;
  double * D = state + internal->offset_variable_D;
  double * A = state + internal->offset_variable_A;
...
SEXP odin_itn_irs_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  odin_itn_irs_internal *internal = odin_itn_irs_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_cov + 27));
  ...
  odin_itn_irs_rhs(internal, scalar_real(t, "t"), REAL(state), REAL(dstatedt), output);
  if (ISNA(initial_t)) {
