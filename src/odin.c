...
SEXP odin_model_create(SEXP user, SEXP odin_use_dde) {
  ...
  odin_model_p->int_len = NA_INTEGER;
  ...
  odin_model_p->itn_cov = NULL;
  odin_model_p->irs_cov = NULL;
  odin_model_p->cov = NULL;
  odin_model_p->delay_cov = NULL;
  odin_model_p->w = NULL;
...
SEXP odin_model_set_user(odin_model_pars *odin_model_p, SEXP user) {
  ...
  odin_model_p->betaL = get_user_double(user, "betaL", odin_model_p->betaL);
  ...
  odin_model_p->int_len = get_user_int(user, "int_len", odin_model_p->int_len);
  ...
  Free(odin_model_p->itn_cov);
  odin_model_p->dim_itn_cov = odin_model_p->int_len;
  odin_model_p->itn_cov = (double*) Calloc(odin_model_p->dim_itn_cov, double);
  get_user_array(user, "itn_cov", true, odin_model_p->itn_cov, 1, odin_model_p->dim_itn_cov);
  Free(odin_model_p->irs_cov);
  odin_model_p->dim_irs_cov = odin_model_p->int_len;
  odin_model_p->irs_cov = (double*) Calloc(odin_model_p->dim_irs_cov, double);
  get_user_array(user, "irs_cov", true, odin_model_p->irs_cov, 1, odin_model_p->dim_irs_cov);
  Free(odin_model_p->cov);
  odin_model_p->dim_cov = odin_model_p->num_int;
  odin_model_p->cov = (double*) Calloc(odin_model_p->dim_cov, double);
  Free(odin_model_p->delay_cov);
  odin_model_p->delay_cov = (double*) Calloc(odin_model_p->dim_cov, double);
  odin_model_p->offset_output_cov = 23;
  Free(odin_model_p->w);
  ...
  odin_model_p->dim_output = 23 + odin_model_p->dim_cov;
  return R_NilValue;
}
...
void odin_model_deriv(odin_model_pars *odin_model_p, double t, double *state, double *dstatedt, double *output) {
  ...
  }
  {
    ...
    double itn_cov_now = (t < odin_model_p->ITN_IRS_on ? 0 : (t - odin_model_p->ITN_IRS_on <= 365 ? odin_model_p->itn_cov[0] : (t - odin_model_p->ITN_IRS_on <= 730 ? odin_model_p->itn_cov[1] : (t - odin_model_p->ITN_IRS_on <= 1095 ? odin_model_p->itn_cov[2] : (t - odin_model_p->ITN_IRS_on <= 1460 ? odin_model_p->itn_cov[3] : (t - odin_model_p->ITN_IRS_on <= 1825 ? odin_model_p->itn_cov[4] : (t - odin_model_p->ITN_IRS_on <= 2190 ? odin_model_p->itn_cov[5] : (t - odin_model_p->ITN_IRS_on <= 2555 ? odin_model_p->itn_cov[6] : (t - odin_model_p->ITN_IRS_on <= 2920 ? odin_model_p->itn_cov[7] : (t - odin_model_p->ITN_IRS_on <= 3285 ? odin_model_p->itn_cov[8] : (t - odin_model_p->ITN_IRS_on <= 3650 ? odin_model_p->itn_cov[9] : (t - odin_model_p->ITN_IRS_on <= 4015 ? odin_model_p->itn_cov[10] : (t - odin_model_p->ITN_IRS_on <= 4380 ? odin_model_p->itn_cov[11] : (t - odin_model_p->ITN_IRS_on <= 4745 ? odin_model_p->itn_cov[12] : (t - odin_model_p->ITN_IRS_on <= 5110 ? odin_model_p->itn_cov[13] : (t - odin_model_p->ITN_IRS_on <= 5475 ? odin_model_p->itn_cov[14] : (t - odin_model_p->ITN_IRS_on <= 5840 ? odin_model_p->itn_cov[15] : (t - odin_model_p->ITN_IRS_on <= 6205 ? odin_model_p->itn_cov[16] : (t - odin_model_p->ITN_IRS_on <= 6570 ? odin_model_p->itn_cov[17] : (t - odin_model_p->ITN_IRS_on <= 6935 ? odin_model_p->itn_cov[18] : (t - odin_model_p->ITN_IRS_on <= 7300 ? odin_model_p->itn_cov[19] : (t - odin_model_p->ITN_IRS_on <= 7665 ? odin_model_p->itn_cov[20] : (t - odin_model_p->ITN_IRS_on <= 8030 ? odin_model_p->itn_cov[21] : (t - odin_model_p->ITN_IRS_on <= 8395 ? odin_model_p->itn_cov[22] : (t - odin_model_p->ITN_IRS_on <= 8760 ? odin_model_p->itn_cov[23] : (t - odin_model_p->ITN_IRS_on <= 9125 ? odin_model_p->itn_cov[24] : (t - odin_model_p->ITN_IRS_on <= 9490 ? odin_model_p->itn_cov[25] : (t - odin_model_p->ITN_IRS_on <= 9855 ? odin_model_p->itn_cov[26] : (t - odin_model_p->ITN_IRS_on <= 10220 ? odin_model_p->itn_cov[27] : (t - odin_model_p->ITN_IRS_on <= 10585 ? odin_model_p->itn_cov[28] : (t - odin_model_p->ITN_IRS_on <= 10950 ? odin_model_p->itn_cov[29] : (t - odin_model_p->ITN_IRS_on <= 11315 ? odin_model_p->itn_cov[30] : (t - odin_model_p->ITN_IRS_on <= 11680 ? odin_model_p->itn_cov[31] : (t - odin_model_p->ITN_IRS_on <= 12045 ? odin_model_p->itn_cov[32] : (t - odin_model_p->ITN_IRS_on <= 12410 ? odin_model_p->itn_cov[33] : (t - odin_model_p->ITN_IRS_on <= 12775 ? odin_model_p->itn_cov[34] : (t - odin_model_p->ITN_IRS_on <= 13140 ? odin_model_p->itn_cov[35] : (t - odin_model_p->ITN_IRS_on <= 13505 ? odin_model_p->itn_cov[36] : (t - odin_model_p->ITN_IRS_on <= 13870 ? odin_model_p->itn_cov[37] : (t - odin_model_p->ITN_IRS_on <= 14235 ? odin_model_p->itn_cov[38] : (t - odin_model_p->ITN_IRS_on <= 14600 ? odin_model_p->itn_cov[39] : (t - odin_model_p->ITN_IRS_on <= 14965 ? odin_model_p->itn_cov[40] : (t - odin_model_p->ITN_IRS_on <= 15330 ? odin_model_p->itn_cov[41] : (t - odin_model_p->ITN_IRS_on <= 15695 ? odin_model_p->itn_cov[42] : (t - odin_model_p->ITN_IRS_on <= 16060 ? odin_model_p->itn_cov[43] : (t - odin_model_p->ITN_IRS_on <= 16425 ? odin_model_p->itn_cov[44] : (t - odin_model_p->ITN_IRS_on <= 16790 ? odin_model_p->itn_cov[45] : (t - odin_model_p->ITN_IRS_on <= 17155 ? odin_model_p->itn_cov[46] : (t - odin_model_p->ITN_IRS_on <= 17520 ? odin_model_p->itn_cov[47] : (t - odin_model_p->ITN_IRS_on <= 17885 ? odin_model_p->itn_cov[48] : (t - odin_model_p->ITN_IRS_on <= 18250 ? odin_model_p->itn_cov[49] : (t - odin_model_p->ITN_IRS_on <= 18615 ? odin_model_p->itn_cov[50] : (t - odin_model_p->ITN_IRS_on <= 18980 ? odin_model_p->itn_cov[51] : (t - odin_model_p->ITN_IRS_on <= 19345 ? odin_model_p->itn_cov[52] : (t - odin_model_p->ITN_IRS_on <= 19710 ? odin_model_p->itn_cov[53] : (t - odin_model_p->ITN_IRS_on <= 20075 ? odin_model_p->itn_cov[54] : (t - odin_model_p->ITN_IRS_on <= 20440 ? odin_model_p->itn_cov[55] : (t - odin_model_p->ITN_IRS_on <= 20805 ? odin_model_p->itn_cov[56] : (t - odin_model_p->ITN_IRS_on <= 21170 ? odin_model_p->itn_cov[57] : (t - odin_model_p->ITN_IRS_on <= 21535 ? odin_model_p->itn_cov[58] : (t - odin_model_p->ITN_IRS_on <= 21900 ? odin_model_p->itn_cov[59] : (t - odin_model_p->ITN_IRS_on <= 22265 ? odin_model_p->itn_cov[60] : (t - odin_model_p->ITN_IRS_on <= 22630 ? odin_model_p->itn_cov[61] : (t - odin_model_p->ITN_IRS_on <= 22995 ? odin_model_p->itn_cov[62] : (t - odin_model_p->ITN_IRS_on <= 23360 ? odin_model_p->itn_cov[63] : (t - odin_model_p->ITN_IRS_on <= 23725 ? odin_model_p->itn_cov[64] : 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
    double irs_cov_now = (t < odin_model_p->ITN_IRS_on ? 0 : (t - odin_model_p->ITN_IRS_on <= 365 ? odin_model_p->irs_cov[0] : (t - odin_model_p->ITN_IRS_on <= 730 ? odin_model_p->irs_cov[1] : (t - odin_model_p->ITN_IRS_on <= 1095 ? odin_model_p->irs_cov[2] : (t - odin_model_p->ITN_IRS_on <= 1460 ? odin_model_p->irs_cov[3] : (t - odin_model_p->ITN_IRS_on <= 1825 ? odin_model_p->irs_cov[4] : (t - odin_model_p->ITN_IRS_on <= 2190 ? odin_model_p->irs_cov[5] : (t - odin_model_p->ITN_IRS_on <= 2555 ? odin_model_p->irs_cov[6] : (t - odin_model_p->ITN_IRS_on <= 2920 ? odin_model_p->irs_cov[7] : (t - odin_model_p->ITN_IRS_on <= 3285 ? odin_model_p->irs_cov[8] : (t - odin_model_p->ITN_IRS_on <= 3650 ? odin_model_p->irs_cov[9] : (t - odin_model_p->ITN_IRS_on <= 4015 ? odin_model_p->irs_cov[10] : (t - odin_model_p->ITN_IRS_on <= 4380 ? odin_model_p->irs_cov[11] : (t - odin_model_p->ITN_IRS_on <= 4745 ? odin_model_p->irs_cov[12] : (t - odin_model_p->ITN_IRS_on <= 5110 ? odin_model_p->irs_cov[13] : (t - odin_model_p->ITN_IRS_on <= 5475 ? odin_model_p->irs_cov[14] : (t - odin_model_p->ITN_IRS_on <= 5840 ? odin_model_p->irs_cov[15] : (t - odin_model_p->ITN_IRS_on <= 6205 ? odin_model_p->irs_cov[16] : (t - odin_model_p->ITN_IRS_on <= 6570 ? odin_model_p->irs_cov[17] : (t - odin_model_p->ITN_IRS_on <= 6935 ? odin_model_p->irs_cov[18] : (t - odin_model_p->ITN_IRS_on <= 7300 ? odin_model_p->irs_cov[19] : (t - odin_model_p->ITN_IRS_on <= 7665 ? odin_model_p->irs_cov[20] : (t - odin_model_p->ITN_IRS_on <= 8030 ? odin_model_p->irs_cov[21] : (t - odin_model_p->ITN_IRS_on <= 8395 ? odin_model_p->irs_cov[22] : (t - odin_model_p->ITN_IRS_on <= 8760 ? odin_model_p->irs_cov[23] : (t - odin_model_p->ITN_IRS_on <= 9125 ? odin_model_p->irs_cov[24] : (t - odin_model_p->ITN_IRS_on <= 9490 ? odin_model_p->irs_cov[25] : (t - odin_model_p->ITN_IRS_on <= 9855 ? odin_model_p->irs_cov[26] : (t - odin_model_p->ITN_IRS_on <= 10220 ? odin_model_p->irs_cov[27] : (t - odin_model_p->ITN_IRS_on <= 10585 ? odin_model_p->irs_cov[28] : (t - odin_model_p->ITN_IRS_on <= 10950 ? odin_model_p->irs_cov[29] : (t - odin_model_p->ITN_IRS_on <= 11315 ? odin_model_p->irs_cov[30] : (t - odin_model_p->ITN_IRS_on <= 11680 ? odin_model_p->irs_cov[31] : (t - odin_model_p->ITN_IRS_on <= 12045 ? odin_model_p->irs_cov[32] : (t - odin_model_p->ITN_IRS_on <= 12410 ? odin_model_p->irs_cov[33] : (t - odin_model_p->ITN_IRS_on <= 12775 ? odin_model_p->irs_cov[34] : (t - odin_model_p->ITN_IRS_on <= 13140 ? odin_model_p->irs_cov[35] : (t - odin_model_p->ITN_IRS_on <= 13505 ? odin_model_p->irs_cov[36] : (t - odin_model_p->ITN_IRS_on <= 13870 ? odin_model_p->irs_cov[37] : (t - odin_model_p->ITN_IRS_on <= 14235 ? odin_model_p->irs_cov[38] : (t - odin_model_p->ITN_IRS_on <= 14600 ? odin_model_p->irs_cov[39] : (t - odin_model_p->ITN_IRS_on <= 14965 ? odin_model_p->irs_cov[40] : (t - odin_model_p->ITN_IRS_on <= 15330 ? odin_model_p->irs_cov[41] : (t - odin_model_p->ITN_IRS_on <= 15695 ? odin_model_p->irs_cov[42] : (t - odin_model_p->ITN_IRS_on <= 16060 ? odin_model_p->irs_cov[43] : (t - odin_model_p->ITN_IRS_on <= 16425 ? odin_model_p->irs_cov[44] : (t - odin_model_p->ITN_IRS_on <= 16790 ? odin_model_p->irs_cov[45] : (t - odin_model_p->ITN_IRS_on <= 17155 ? odin_model_p->irs_cov[46] : (t - odin_model_p->ITN_IRS_on <= 17520 ? odin_model_p->irs_cov[47] : (t - odin_model_p->ITN_IRS_on <= 17885 ? odin_model_p->irs_cov[48] : (t - odin_model_p->ITN_IRS_on <= 18250 ? odin_model_p->irs_cov[49] : (t - odin_model_p->ITN_IRS_on <= 18615 ? odin_model_p->irs_cov[50] : (t - odin_model_p->ITN_IRS_on <= 18980 ? odin_model_p->irs_cov[51] : (t - odin_model_p->ITN_IRS_on <= 19345 ? odin_model_p->irs_cov[52] : (t - odin_model_p->ITN_IRS_on <= 19710 ? odin_model_p->irs_cov[53] : (t - odin_model_p->ITN_IRS_on <= 20075 ? odin_model_p->irs_cov[54] : (t - odin_model_p->ITN_IRS_on <= 20440 ? odin_model_p->irs_cov[55] : (t - odin_model_p->ITN_IRS_on <= 20805 ? odin_model_p->irs_cov[56] : (t - odin_model_p->ITN_IRS_on <= 21170 ? odin_model_p->irs_cov[57] : (t - odin_model_p->ITN_IRS_on <= 21535 ? odin_model_p->irs_cov[58] : (t - odin_model_p->ITN_IRS_on <= 21900 ? odin_model_p->irs_cov[59] : (t - odin_model_p->ITN_IRS_on <= 22265 ? odin_model_p->irs_cov[60] : (t - odin_model_p->ITN_IRS_on <= 22630 ? odin_model_p->irs_cov[61] : (t - odin_model_p->ITN_IRS_on <= 22995 ? odin_model_p->irs_cov[62] : (t - odin_model_p->ITN_IRS_on <= 23360 ? odin_model_p->irs_cov[63] : (t - odin_model_p->ITN_IRS_on <= 23725 ? odin_model_p->irs_cov[64] : 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
    odin_model_p->delay_cov[0] = (1 - itn_cov_now) * (1 - irs_cov_now);
    odin_model_p->delay_cov[1] = itn_cov_now * (1 - irs_cov_now);
    odin_model_p->delay_cov[2] = (1 - itn_cov_now) * irs_cov_now;
    odin_model_p->delay_cov[3] = itn_cov_now * irs_cov_now;
    ...
    for (int i = 0; i < odin_model_p->num_int; ++i) {
      odin_model_p->delay_zhi[i] = odin_model_p->delay_cov[i] * odin_model_p->delay_z[i];
    }
    for (int i = 0; i < odin_model_p->num_int; ++i) {
      odin_model_p->delay_whi[i] = odin_model_p->delay_cov[i] * odin_model_p->delay_w[i];
    }
  ...
  double itn_cov_now = (t < odin_model_p->ITN_IRS_on ? 0 : (t - odin_model_p->ITN_IRS_on <= 365 ? odin_model_p->itn_cov[0] : (t - odin_model_p->ITN_IRS_on <= 730 ? odin_model_p->itn_cov[1] : (t - odin_model_p->ITN_IRS_on <= 1095 ? odin_model_p->itn_cov[2] : (t - odin_model_p->ITN_IRS_on <= 1460 ? odin_model_p->itn_cov[3] : (t - odin_model_p->ITN_IRS_on <= 1825 ? odin_model_p->itn_cov[4] : (t - odin_model_p->ITN_IRS_on <= 2190 ? odin_model_p->itn_cov[5] : (t - odin_model_p->ITN_IRS_on <= 2555 ? odin_model_p->itn_cov[6] : (t - odin_model_p->ITN_IRS_on <= 2920 ? odin_model_p->itn_cov[7] : (t - odin_model_p->ITN_IRS_on <= 3285 ? odin_model_p->itn_cov[8] : (t - odin_model_p->ITN_IRS_on <= 3650 ? odin_model_p->itn_cov[9] : (t - odin_model_p->ITN_IRS_on <= 4015 ? odin_model_p->itn_cov[10] : (t - odin_model_p->ITN_IRS_on <= 4380 ? odin_model_p->itn_cov[11] : (t - odin_model_p->ITN_IRS_on <= 4745 ? odin_model_p->itn_cov[12] : (t - odin_model_p->ITN_IRS_on <= 5110 ? odin_model_p->itn_cov[13] : (t - odin_model_p->ITN_IRS_on <= 5475 ? odin_model_p->itn_cov[14] : (t - odin_model_p->ITN_IRS_on <= 5840 ? odin_model_p->itn_cov[15] : (t - odin_model_p->ITN_IRS_on <= 6205 ? odin_model_p->itn_cov[16] : (t - odin_model_p->ITN_IRS_on <= 6570 ? odin_model_p->itn_cov[17] : (t - odin_model_p->ITN_IRS_on <= 6935 ? odin_model_p->itn_cov[18] : (t - odin_model_p->ITN_IRS_on <= 7300 ? odin_model_p->itn_cov[19] : (t - odin_model_p->ITN_IRS_on <= 7665 ? odin_model_p->itn_cov[20] : (t - odin_model_p->ITN_IRS_on <= 8030 ? odin_model_p->itn_cov[21] : (t - odin_model_p->ITN_IRS_on <= 8395 ? odin_model_p->itn_cov[22] : (t - odin_model_p->ITN_IRS_on <= 8760 ? odin_model_p->itn_cov[23] : (t - odin_model_p->ITN_IRS_on <= 9125 ? odin_model_p->itn_cov[24] : (t - odin_model_p->ITN_IRS_on <= 9490 ? odin_model_p->itn_cov[25] : (t - odin_model_p->ITN_IRS_on <= 9855 ? odin_model_p->itn_cov[26] : (t - odin_model_p->ITN_IRS_on <= 10220 ? odin_model_p->itn_cov[27] : (t - odin_model_p->ITN_IRS_on <= 10585 ? odin_model_p->itn_cov[28] : (t - odin_model_p->ITN_IRS_on <= 10950 ? odin_model_p->itn_cov[29] : (t - odin_model_p->ITN_IRS_on <= 11315 ? odin_model_p->itn_cov[30] : (t - odin_model_p->ITN_IRS_on <= 11680 ? odin_model_p->itn_cov[31] : (t - odin_model_p->ITN_IRS_on <= 12045 ? odin_model_p->itn_cov[32] : (t - odin_model_p->ITN_IRS_on <= 12410 ? odin_model_p->itn_cov[33] : (t - odin_model_p->ITN_IRS_on <= 12775 ? odin_model_p->itn_cov[34] : (t - odin_model_p->ITN_IRS_on <= 13140 ? odin_model_p->itn_cov[35] : (t - odin_model_p->ITN_IRS_on <= 13505 ? odin_model_p->itn_cov[36] : (t - odin_model_p->ITN_IRS_on <= 13870 ? odin_model_p->itn_cov[37] : (t - odin_model_p->ITN_IRS_on <= 14235 ? odin_model_p->itn_cov[38] : (t - odin_model_p->ITN_IRS_on <= 14600 ? odin_model_p->itn_cov[39] : (t - odin_model_p->ITN_IRS_on <= 14965 ? odin_model_p->itn_cov[40] : (t - odin_model_p->ITN_IRS_on <= 15330 ? odin_model_p->itn_cov[41] : (t - odin_model_p->ITN_IRS_on <= 15695 ? odin_model_p->itn_cov[42] : (t - odin_model_p->ITN_IRS_on <= 16060 ? odin_model_p->itn_cov[43] : (t - odin_model_p->ITN_IRS_on <= 16425 ? odin_model_p->itn_cov[44] : (t - odin_model_p->ITN_IRS_on <= 16790 ? odin_model_p->itn_cov[45] : (t - odin_model_p->ITN_IRS_on <= 17155 ? odin_model_p->itn_cov[46] : (t - odin_model_p->ITN_IRS_on <= 17520 ? odin_model_p->itn_cov[47] : (t - odin_model_p->ITN_IRS_on <= 17885 ? odin_model_p->itn_cov[48] : (t - odin_model_p->ITN_IRS_on <= 18250 ? odin_model_p->itn_cov[49] : (t - odin_model_p->ITN_IRS_on <= 18615 ? odin_model_p->itn_cov[50] : (t - odin_model_p->ITN_IRS_on <= 18980 ? odin_model_p->itn_cov[51] : (t - odin_model_p->ITN_IRS_on <= 19345 ? odin_model_p->itn_cov[52] : (t - odin_model_p->ITN_IRS_on <= 19710 ? odin_model_p->itn_cov[53] : (t - odin_model_p->ITN_IRS_on <= 20075 ? odin_model_p->itn_cov[54] : (t - odin_model_p->ITN_IRS_on <= 20440 ? odin_model_p->itn_cov[55] : (t - odin_model_p->ITN_IRS_on <= 20805 ? odin_model_p->itn_cov[56] : (t - odin_model_p->ITN_IRS_on <= 21170 ? odin_model_p->itn_cov[57] : (t - odin_model_p->ITN_IRS_on <= 21535 ? odin_model_p->itn_cov[58] : (t - odin_model_p->ITN_IRS_on <= 21900 ? odin_model_p->itn_cov[59] : (t - odin_model_p->ITN_IRS_on <= 22265 ? odin_model_p->itn_cov[60] : (t - odin_model_p->ITN_IRS_on <= 22630 ? odin_model_p->itn_cov[61] : (t - odin_model_p->ITN_IRS_on <= 22995 ? odin_model_p->itn_cov[62] : (t - odin_model_p->ITN_IRS_on <= 23360 ? odin_model_p->itn_cov[63] : (t - odin_model_p->ITN_IRS_on <= 23725 ? odin_model_p->itn_cov[64] : 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
  double irs_cov_now = (t < odin_model_p->ITN_IRS_on ? 0 : (t - odin_model_p->ITN_IRS_on <= 365 ? odin_model_p->irs_cov[0] : (t - odin_model_p->ITN_IRS_on <= 730 ? odin_model_p->irs_cov[1] : (t - odin_model_p->ITN_IRS_on <= 1095 ? odin_model_p->irs_cov[2] : (t - odin_model_p->ITN_IRS_on <= 1460 ? odin_model_p->irs_cov[3] : (t - odin_model_p->ITN_IRS_on <= 1825 ? odin_model_p->irs_cov[4] : (t - odin_model_p->ITN_IRS_on <= 2190 ? odin_model_p->irs_cov[5] : (t - odin_model_p->ITN_IRS_on <= 2555 ? odin_model_p->irs_cov[6] : (t - odin_model_p->ITN_IRS_on <= 2920 ? odin_model_p->irs_cov[7] : (t - odin_model_p->ITN_IRS_on <= 3285 ? odin_model_p->irs_cov[8] : (t - odin_model_p->ITN_IRS_on <= 3650 ? odin_model_p->irs_cov[9] : (t - odin_model_p->ITN_IRS_on <= 4015 ? odin_model_p->irs_cov[10] : (t - odin_model_p->ITN_IRS_on <= 4380 ? odin_model_p->irs_cov[11] : (t - odin_model_p->ITN_IRS_on <= 4745 ? odin_model_p->irs_cov[12] : (t - odin_model_p->ITN_IRS_on <= 5110 ? odin_model_p->irs_cov[13] : (t - odin_model_p->ITN_IRS_on <= 5475 ? odin_model_p->irs_cov[14] : (t - odin_model_p->ITN_IRS_on <= 5840 ? odin_model_p->irs_cov[15] : (t - odin_model_p->ITN_IRS_on <= 6205 ? odin_model_p->irs_cov[16] : (t - odin_model_p->ITN_IRS_on <= 6570 ? odin_model_p->irs_cov[17] : (t - odin_model_p->ITN_IRS_on <= 6935 ? odin_model_p->irs_cov[18] : (t - odin_model_p->ITN_IRS_on <= 7300 ? odin_model_p->irs_cov[19] : (t - odin_model_p->ITN_IRS_on <= 7665 ? odin_model_p->irs_cov[20] : (t - odin_model_p->ITN_IRS_on <= 8030 ? odin_model_p->irs_cov[21] : (t - odin_model_p->ITN_IRS_on <= 8395 ? odin_model_p->irs_cov[22] : (t - odin_model_p->ITN_IRS_on <= 8760 ? odin_model_p->irs_cov[23] : (t - odin_model_p->ITN_IRS_on <= 9125 ? odin_model_p->irs_cov[24] : (t - odin_model_p->ITN_IRS_on <= 9490 ? odin_model_p->irs_cov[25] : (t - odin_model_p->ITN_IRS_on <= 9855 ? odin_model_p->irs_cov[26] : (t - odin_model_p->ITN_IRS_on <= 10220 ? odin_model_p->irs_cov[27] : (t - odin_model_p->ITN_IRS_on <= 10585 ? odin_model_p->irs_cov[28] : (t - odin_model_p->ITN_IRS_on <= 10950 ? odin_model_p->irs_cov[29] : (t - odin_model_p->ITN_IRS_on <= 11315 ? odin_model_p->irs_cov[30] : (t - odin_model_p->ITN_IRS_on <= 11680 ? odin_model_p->irs_cov[31] : (t - odin_model_p->ITN_IRS_on <= 12045 ? odin_model_p->irs_cov[32] : (t - odin_model_p->ITN_IRS_on <= 12410 ? odin_model_p->irs_cov[33] : (t - odin_model_p->ITN_IRS_on <= 12775 ? odin_model_p->irs_cov[34] : (t - odin_model_p->ITN_IRS_on <= 13140 ? odin_model_p->irs_cov[35] : (t - odin_model_p->ITN_IRS_on <= 13505 ? odin_model_p->irs_cov[36] : (t - odin_model_p->ITN_IRS_on <= 13870 ? odin_model_p->irs_cov[37] : (t - odin_model_p->ITN_IRS_on <= 14235 ? odin_model_p->irs_cov[38] : (t - odin_model_p->ITN_IRS_on <= 14600 ? odin_model_p->irs_cov[39] : (t - odin_model_p->ITN_IRS_on <= 14965 ? odin_model_p->irs_cov[40] : (t - odin_model_p->ITN_IRS_on <= 15330 ? odin_model_p->irs_cov[41] : (t - odin_model_p->ITN_IRS_on <= 15695 ? odin_model_p->irs_cov[42] : (t - odin_model_p->ITN_IRS_on <= 16060 ? odin_model_p->irs_cov[43] : (t - odin_model_p->ITN_IRS_on <= 16425 ? odin_model_p->irs_cov[44] : (t - odin_model_p->ITN_IRS_on <= 16790 ? odin_model_p->irs_cov[45] : (t - odin_model_p->ITN_IRS_on <= 17155 ? odin_model_p->irs_cov[46] : (t - odin_model_p->ITN_IRS_on <= 17520 ? odin_model_p->irs_cov[47] : (t - odin_model_p->ITN_IRS_on <= 17885 ? odin_model_p->irs_cov[48] : (t - odin_model_p->ITN_IRS_on <= 18250 ? odin_model_p->irs_cov[49] : (t - odin_model_p->ITN_IRS_on <= 18615 ? odin_model_p->irs_cov[50] : (t - odin_model_p->ITN_IRS_on <= 18980 ? odin_model_p->irs_cov[51] : (t - odin_model_p->ITN_IRS_on <= 19345 ? odin_model_p->irs_cov[52] : (t - odin_model_p->ITN_IRS_on <= 19710 ? odin_model_p->irs_cov[53] : (t - odin_model_p->ITN_IRS_on <= 20075 ? odin_model_p->irs_cov[54] : (t - odin_model_p->ITN_IRS_on <= 20440 ? odin_model_p->irs_cov[55] : (t - odin_model_p->ITN_IRS_on <= 20805 ? odin_model_p->irs_cov[56] : (t - odin_model_p->ITN_IRS_on <= 21170 ? odin_model_p->irs_cov[57] : (t - odin_model_p->ITN_IRS_on <= 21535 ? odin_model_p->irs_cov[58] : (t - odin_model_p->ITN_IRS_on <= 21900 ? odin_model_p->irs_cov[59] : (t - odin_model_p->ITN_IRS_on <= 22265 ? odin_model_p->irs_cov[60] : (t - odin_model_p->ITN_IRS_on <= 22630 ? odin_model_p->irs_cov[61] : (t - odin_model_p->ITN_IRS_on <= 22995 ? odin_model_p->irs_cov[62] : (t - odin_model_p->ITN_IRS_on <= 23360 ? odin_model_p->irs_cov[63] : (t - odin_model_p->ITN_IRS_on <= 23725 ? odin_model_p->irs_cov[64] : 0))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))));
  odin_model_p->cov[0] = (1 - itn_cov_now) * (1 - irs_cov_now);
  odin_model_p->cov[1] = itn_cov_now * (1 - irs_cov_now);
  odin_model_p->cov[2] = (1 - itn_cov_now) * irs_cov_now;
  odin_model_p->cov[3] = itn_cov_now * irs_cov_now;
  {
    int i = 0;
    for (int j = 0; j < odin_model_p->nh; ++j) {
      for (int k = 0; k < odin_model_p->num_int; ++k) {
  ...
  double eov = odin_model_p->betaL / mu * (exp(mu / fv) - 1);
...
SEXP odin_model_contents(SEXP odin_model_ptr) {
  odin_model_pars *odin_model_p = odin_model_get_pointer(odin_model_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 365));
  ...
  SET_VECTOR_ELT(state, 67, ScalarReal(odin_model_p->betaL));
  ...
  SET_VECTOR_ELT(state, 73, ScalarInteger(odin_model_p->int_len));
  SET_VECTOR_ELT(state, 74, ScalarReal(odin_model_p->IRS_interval));
  SET_VECTOR_ELT(state, 75, ScalarReal(odin_model_p->ITN_interval));
  SET_VECTOR_ELT(state, 76, ScalarReal(odin_model_p->chi));
  SET_VECTOR_ELT(state, 77, ScalarReal(odin_model_p->Q0));
  SET_VECTOR_ELT(state, 78, ScalarReal(odin_model_p->bites_Bed));
  SET_VECTOR_ELT(state, 79, ScalarReal(odin_model_p->bites_Indoors));
  SET_VECTOR_ELT(state, 80, ScalarReal(odin_model_p->r_ITN0));
  SET_VECTOR_ELT(state, 81, ScalarReal(odin_model_p->d_ITN0));
  SET_VECTOR_ELT(state, 82, ScalarReal(odin_model_p->d_IRS0));
  SET_VECTOR_ELT(state, 83, ScalarReal(odin_model_p->r_IRS0));
  SET_VECTOR_ELT(state, 84, ScalarReal(odin_model_p->r_ITN1));
  SET_VECTOR_ELT(state, 85, ScalarReal(odin_model_p->irs_loss));
  SET_VECTOR_ELT(state, 86, ScalarReal(odin_model_p->itn_loss));
  SET_VECTOR_ELT(state, 87, ScalarInteger(odin_model_p->age59));
  SET_VECTOR_ELT(state, 88, ScalarInteger(odin_model_p->age05));
  SET_VECTOR_ELT(state, 89, ScalarInteger(odin_model_p->dim_age_rate));
  SET_VECTOR_ELT(state, 90, allocVector(REALSXP, odin_model_p->dim_age_rate));
  memcpy(REAL(VECTOR_ELT(state, 90)), odin_model_p->age_rate, odin_model_p->dim_age_rate * sizeof(double));
  SET_VECTOR_ELT(state, 91, ScalarInteger(odin_model_p->dim_het_wt));
  SET_VECTOR_ELT(state, 92, allocVector(REALSXP, odin_model_p->dim_het_wt));
  memcpy(REAL(VECTOR_ELT(state, 92)), odin_model_p->het_wt, odin_model_p->dim_het_wt * sizeof(double));
  SET_VECTOR_ELT(state, 93, ScalarInteger(odin_model_p->dim_init_S));
  SET_VECTOR_ELT(state, 94, ScalarInteger(odin_model_p->dim_init_S_1));
  SET_VECTOR_ELT(state, 95, ScalarInteger(odin_model_p->dim_init_S_2));
  SET_VECTOR_ELT(state, 96, ScalarInteger(odin_model_p->dim_init_S_3));
  SET_VECTOR_ELT(state, 97, ScalarInteger(odin_model_p->dim_init_S_12));
  SET_VECTOR_ELT(state, 98, allocVector(REALSXP, odin_model_p->dim_init_S));
  memcpy(REAL(VECTOR_ELT(state, 98)), odin_model_p->init_S, odin_model_p->dim_init_S * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 98), 3, odin_model_p->dim_init_S_1, odin_model_p->dim_init_S_2, odin_model_p->dim_init_S_3);
  SET_VECTOR_ELT(state, 99, ScalarInteger(odin_model_p->dim_S));
  SET_VECTOR_ELT(state, 100, ScalarInteger(odin_model_p->dim_S_1));
  SET_VECTOR_ELT(state, 101, ScalarInteger(odin_model_p->dim_S_2));
  SET_VECTOR_ELT(state, 102, ScalarInteger(odin_model_p->dim_S_3));
  SET_VECTOR_ELT(state, 103, ScalarInteger(odin_model_p->dim_S_12));
  SET_VECTOR_ELT(state, 104, allocVector(REALSXP, odin_model_p->dim_S));
  memcpy(REAL(VECTOR_ELT(state, 104)), odin_model_p->initial_S, odin_model_p->dim_S * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 104), 3, odin_model_p->dim_S_1, odin_model_p->dim_S_2, odin_model_p->dim_S_3);
  SET_VECTOR_ELT(state, 105, ScalarInteger(odin_model_p->offset_S));
  SET_VECTOR_ELT(state, 106, ScalarInteger(odin_model_p->dim_init_T));
  SET_VECTOR_ELT(state, 107, ScalarInteger(odin_model_p->dim_init_T_1));
  SET_VECTOR_ELT(state, 108, ScalarInteger(odin_model_p->dim_init_T_2));
  SET_VECTOR_ELT(state, 109, ScalarInteger(odin_model_p->dim_init_T_3));
  SET_VECTOR_ELT(state, 110, ScalarInteger(odin_model_p->dim_init_T_12));
  SET_VECTOR_ELT(state, 111, allocVector(REALSXP, odin_model_p->dim_init_T));
  memcpy(REAL(VECTOR_ELT(state, 111)), odin_model_p->init_T, odin_model_p->dim_init_T * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 111), 3, odin_model_p->dim_init_T_1, odin_model_p->dim_init_T_2, odin_model_p->dim_init_T_3);
  SET_VECTOR_ELT(state, 112, ScalarInteger(odin_model_p->dim_T));
  SET_VECTOR_ELT(state, 113, ScalarInteger(odin_model_p->dim_T_1));
  SET_VECTOR_ELT(state, 114, ScalarInteger(odin_model_p->dim_T_2));
  SET_VECTOR_ELT(state, 115, ScalarInteger(odin_model_p->dim_T_3));
  SET_VECTOR_ELT(state, 116, ScalarInteger(odin_model_p->dim_T_12));
  SET_VECTOR_ELT(state, 117, allocVector(REALSXP, odin_model_p->dim_T));
  memcpy(REAL(VECTOR_ELT(state, 117)), odin_model_p->initial_T, odin_model_p->dim_T * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 117), 3, odin_model_p->dim_T_1, odin_model_p->dim_T_2, odin_model_p->dim_T_3);
  SET_VECTOR_ELT(state, 118, ScalarInteger(odin_model_p->offset_T));
  SET_VECTOR_ELT(state, 119, ScalarInteger(odin_model_p->dim_init_D));
  SET_VECTOR_ELT(state, 120, ScalarInteger(odin_model_p->dim_init_D_1));
  SET_VECTOR_ELT(state, 121, ScalarInteger(odin_model_p->dim_init_D_2));
  SET_VECTOR_ELT(state, 122, ScalarInteger(odin_model_p->dim_init_D_3));
  SET_VECTOR_ELT(state, 123, ScalarInteger(odin_model_p->dim_init_D_12));
  SET_VECTOR_ELT(state, 124, allocVector(REALSXP, odin_model_p->dim_init_D));
  memcpy(REAL(VECTOR_ELT(state, 124)), odin_model_p->init_D, odin_model_p->dim_init_D * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 124), 3, odin_model_p->dim_init_D_1, odin_model_p->dim_init_D_2, odin_model_p->dim_init_D_3);
  SET_VECTOR_ELT(state, 125, ScalarInteger(odin_model_p->dim_D));
  SET_VECTOR_ELT(state, 126, ScalarInteger(odin_model_p->dim_D_1));
  SET_VECTOR_ELT(state, 127, ScalarInteger(odin_model_p->dim_D_2));
  SET_VECTOR_ELT(state, 128, ScalarInteger(odin_model_p->dim_D_3));
  SET_VECTOR_ELT(state, 129, ScalarInteger(odin_model_p->dim_D_12));
  SET_VECTOR_ELT(state, 130, allocVector(REALSXP, odin_model_p->dim_D));
  memcpy(REAL(VECTOR_ELT(state, 130)), odin_model_p->initial_D, odin_model_p->dim_D * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 130), 3, odin_model_p->dim_D_1, odin_model_p->dim_D_2, odin_model_p->dim_D_3);
  SET_VECTOR_ELT(state, 131, ScalarInteger(odin_model_p->offset_D));
  SET_VECTOR_ELT(state, 132, ScalarInteger(odin_model_p->dim_init_A));
  SET_VECTOR_ELT(state, 133, ScalarInteger(odin_model_p->dim_init_A_1));
  SET_VECTOR_ELT(state, 134, ScalarInteger(odin_model_p->dim_init_A_2));
  SET_VECTOR_ELT(state, 135, ScalarInteger(odin_model_p->dim_init_A_3));
  SET_VECTOR_ELT(state, 136, ScalarInteger(odin_model_p->dim_init_A_12));
  SET_VECTOR_ELT(state, 137, allocVector(REALSXP, odin_model_p->dim_init_A));
  memcpy(REAL(VECTOR_ELT(state, 137)), odin_model_p->init_A, odin_model_p->dim_init_A * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 137), 3, odin_model_p->dim_init_A_1, odin_model_p->dim_init_A_2, odin_model_p->dim_init_A_3);
  SET_VECTOR_ELT(state, 138, ScalarInteger(odin_model_p->dim_A));
  SET_VECTOR_ELT(state, 139, ScalarInteger(odin_model_p->dim_A_1));
  SET_VECTOR_ELT(state, 140, ScalarInteger(odin_model_p->dim_A_2));
  SET_VECTOR_ELT(state, 141, ScalarInteger(odin_model_p->dim_A_3));
  SET_VECTOR_ELT(state, 142, ScalarInteger(odin_model_p->dim_A_12));
  SET_VECTOR_ELT(state, 143, allocVector(REALSXP, odin_model_p->dim_A));
  memcpy(REAL(VECTOR_ELT(state, 143)), odin_model_p->initial_A, odin_model_p->dim_A * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 143), 3, odin_model_p->dim_A_1, odin_model_p->dim_A_2, odin_model_p->dim_A_3);
  SET_VECTOR_ELT(state, 144, ScalarInteger(odin_model_p->offset_A));
  SET_VECTOR_ELT(state, 145, ScalarInteger(odin_model_p->dim_init_U));
  SET_VECTOR_ELT(state, 146, ScalarInteger(odin_model_p->dim_init_U_1));
  SET_VECTOR_ELT(state, 147, ScalarInteger(odin_model_p->dim_init_U_2));
  SET_VECTOR_ELT(state, 148, ScalarInteger(odin_model_p->dim_init_U_3));
  SET_VECTOR_ELT(state, 149, ScalarInteger(odin_model_p->dim_init_U_12));
  SET_VECTOR_ELT(state, 150, allocVector(REALSXP, odin_model_p->dim_init_U));
  memcpy(REAL(VECTOR_ELT(state, 150)), odin_model_p->init_U, odin_model_p->dim_init_U * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 150), 3, odin_model_p->dim_init_U_1, odin_model_p->dim_init_U_2, odin_model_p->dim_init_U_3);
  SET_VECTOR_ELT(state, 151, ScalarInteger(odin_model_p->dim_U));
  SET_VECTOR_ELT(state, 152, ScalarInteger(odin_model_p->dim_U_1));
  SET_VECTOR_ELT(state, 153, ScalarInteger(odin_model_p->dim_U_2));
  SET_VECTOR_ELT(state, 154, ScalarInteger(odin_model_p->dim_U_3));
  SET_VECTOR_ELT(state, 155, ScalarInteger(odin_model_p->dim_U_12));
  SET_VECTOR_ELT(state, 156, allocVector(REALSXP, odin_model_p->dim_U));
  memcpy(REAL(VECTOR_ELT(state, 156)), odin_model_p->initial_U, odin_model_p->dim_U * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 156), 3, odin_model_p->dim_U_1, odin_model_p->dim_U_2, odin_model_p->dim_U_3);
  SET_VECTOR_ELT(state, 157, ScalarInteger(odin_model_p->offset_U));
  SET_VECTOR_ELT(state, 158, ScalarInteger(odin_model_p->dim_init_P));
  SET_VECTOR_ELT(state, 159, ScalarInteger(odin_model_p->dim_init_P_1));
  SET_VECTOR_ELT(state, 160, ScalarInteger(odin_model_p->dim_init_P_2));
  SET_VECTOR_ELT(state, 161, ScalarInteger(odin_model_p->dim_init_P_3));
  SET_VECTOR_ELT(state, 162, ScalarInteger(odin_model_p->dim_init_P_12));
  SET_VECTOR_ELT(state, 163, allocVector(REALSXP, odin_model_p->dim_init_P));
  memcpy(REAL(VECTOR_ELT(state, 163)), odin_model_p->init_P, odin_model_p->dim_init_P * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 163), 3, odin_model_p->dim_init_P_1, odin_model_p->dim_init_P_2, odin_model_p->dim_init_P_3);
  SET_VECTOR_ELT(state, 164, ScalarInteger(odin_model_p->dim_P));
  SET_VECTOR_ELT(state, 165, ScalarInteger(odin_model_p->dim_P_1));
  SET_VECTOR_ELT(state, 166, ScalarInteger(odin_model_p->dim_P_2));
  SET_VECTOR_ELT(state, 167, ScalarInteger(odin_model_p->dim_P_3));
  SET_VECTOR_ELT(state, 168, ScalarInteger(odin_model_p->dim_P_12));
  SET_VECTOR_ELT(state, 169, allocVector(REALSXP, odin_model_p->dim_P));
  memcpy(REAL(VECTOR_ELT(state, 169)), odin_model_p->initial_P, odin_model_p->dim_P * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 169), 3, odin_model_p->dim_P_1, odin_model_p->dim_P_2, odin_model_p->dim_P_3);
  SET_VECTOR_ELT(state, 170, ScalarInteger(odin_model_p->offset_P));
  SET_VECTOR_ELT(state, 171, ScalarInteger(odin_model_p->dim_Y));
  SET_VECTOR_ELT(state, 172, ScalarInteger(odin_model_p->dim_Y_1));
  SET_VECTOR_ELT(state, 173, ScalarInteger(odin_model_p->dim_Y_2));
  SET_VECTOR_ELT(state, 174, ScalarInteger(odin_model_p->dim_Y_3));
  SET_VECTOR_ELT(state, 175, ScalarInteger(odin_model_p->dim_Y_12));
  SET_VECTOR_ELT(state, 176, allocVector(REALSXP, odin_model_p->dim_Y));
  memcpy(REAL(VECTOR_ELT(state, 176)), odin_model_p->Y, odin_model_p->dim_Y * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 176), 3, odin_model_p->dim_Y_1, odin_model_p->dim_Y_2, odin_model_p->dim_Y_3);
  SET_VECTOR_ELT(state, 177, ScalarInteger(odin_model_p->dim_clin_inc));
  SET_VECTOR_ELT(state, 178, ScalarInteger(odin_model_p->dim_clin_inc_1));
  SET_VECTOR_ELT(state, 179, ScalarInteger(odin_model_p->dim_clin_inc_2));
  SET_VECTOR_ELT(state, 180, ScalarInteger(odin_model_p->dim_clin_inc_3));
  SET_VECTOR_ELT(state, 181, ScalarInteger(odin_model_p->dim_clin_inc_12));
  SET_VECTOR_ELT(state, 182, allocVector(REALSXP, odin_model_p->dim_clin_inc));
  memcpy(REAL(VECTOR_ELT(state, 182)), odin_model_p->clin_inc, odin_model_p->dim_clin_inc * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 182), 3, odin_model_p->dim_clin_inc_1, odin_model_p->dim_clin_inc_2, odin_model_p->dim_clin_inc_3);
  SET_VECTOR_ELT(state, 183, ScalarInteger(odin_model_p->dim_x_I));
  SET_VECTOR_ELT(state, 184, allocVector(REALSXP, odin_model_p->dim_x_I));
  memcpy(REAL(VECTOR_ELT(state, 184)), odin_model_p->x_I, odin_model_p->dim_x_I * sizeof(double));
  SET_VECTOR_ELT(state, 185, ScalarInteger(odin_model_p->dim_init_ICM));
  SET_VECTOR_ELT(state, 186, ScalarInteger(odin_model_p->dim_init_ICM_1));
  SET_VECTOR_ELT(state, 187, ScalarInteger(odin_model_p->dim_init_ICM_2));
  SET_VECTOR_ELT(state, 188, ScalarInteger(odin_model_p->dim_init_ICM_3));
  SET_VECTOR_ELT(state, 189, ScalarInteger(odin_model_p->dim_init_ICM_12));
  SET_VECTOR_ELT(state, 190, allocVector(REALSXP, odin_model_p->dim_init_ICM));
  memcpy(REAL(VECTOR_ELT(state, 190)), odin_model_p->init_ICM, odin_model_p->dim_init_ICM * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 190), 3, odin_model_p->dim_init_ICM_1, odin_model_p->dim_init_ICM_2, odin_model_p->dim_init_ICM_3);
  SET_VECTOR_ELT(state, 191, ScalarInteger(odin_model_p->dim_ICM));
  SET_VECTOR_ELT(state, 192, ScalarInteger(odin_model_p->dim_ICM_1));
  SET_VECTOR_ELT(state, 193, ScalarInteger(odin_model_p->dim_ICM_2));
  SET_VECTOR_ELT(state, 194, ScalarInteger(odin_model_p->dim_ICM_3));
  SET_VECTOR_ELT(state, 195, ScalarInteger(odin_model_p->dim_ICM_12));
  SET_VECTOR_ELT(state, 196, allocVector(REALSXP, odin_model_p->dim_ICM));
  memcpy(REAL(VECTOR_ELT(state, 196)), odin_model_p->initial_ICM, odin_model_p->dim_ICM * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 196), 3, odin_model_p->dim_ICM_1, odin_model_p->dim_ICM_2, odin_model_p->dim_ICM_3);
  SET_VECTOR_ELT(state, 197, ScalarInteger(odin_model_p->offset_ICM));
  SET_VECTOR_ELT(state, 198, ScalarInteger(odin_model_p->dim_init_ICA));
  SET_VECTOR_ELT(state, 199, ScalarInteger(odin_model_p->dim_init_ICA_1));
  SET_VECTOR_ELT(state, 200, ScalarInteger(odin_model_p->dim_init_ICA_2));
  SET_VECTOR_ELT(state, 201, ScalarInteger(odin_model_p->dim_init_ICA_3));
  SET_VECTOR_ELT(state, 202, ScalarInteger(odin_model_p->dim_init_ICA_12));
  SET_VECTOR_ELT(state, 203, allocVector(REALSXP, odin_model_p->dim_init_ICA));
  memcpy(REAL(VECTOR_ELT(state, 203)), odin_model_p->init_ICA, odin_model_p->dim_init_ICA * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 203), 3, odin_model_p->dim_init_ICA_1, odin_model_p->dim_init_ICA_2, odin_model_p->dim_init_ICA_3);
  SET_VECTOR_ELT(state, 204, ScalarInteger(odin_model_p->dim_ICA));
  SET_VECTOR_ELT(state, 205, ScalarInteger(odin_model_p->dim_ICA_1));
  SET_VECTOR_ELT(state, 206, ScalarInteger(odin_model_p->dim_ICA_2));
  SET_VECTOR_ELT(state, 207, ScalarInteger(odin_model_p->dim_ICA_3));
  SET_VECTOR_ELT(state, 208, ScalarInteger(odin_model_p->dim_ICA_12));
  SET_VECTOR_ELT(state, 209, allocVector(REALSXP, odin_model_p->dim_ICA));
  memcpy(REAL(VECTOR_ELT(state, 209)), odin_model_p->initial_ICA, odin_model_p->dim_ICA * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 209), 3, odin_model_p->dim_ICA_1, odin_model_p->dim_ICA_2, odin_model_p->dim_ICA_3);
  SET_VECTOR_ELT(state, 210, ScalarInteger(odin_model_p->offset_ICA));
  SET_VECTOR_ELT(state, 211, ScalarInteger(odin_model_p->dim_IC));
  SET_VECTOR_ELT(state, 212, ScalarInteger(odin_model_p->dim_IC_1));
  SET_VECTOR_ELT(state, 213, ScalarInteger(odin_model_p->dim_IC_2));
  SET_VECTOR_ELT(state, 214, ScalarInteger(odin_model_p->dim_IC_3));
  SET_VECTOR_ELT(state, 215, ScalarInteger(odin_model_p->dim_IC_12));
  SET_VECTOR_ELT(state, 216, allocVector(REALSXP, odin_model_p->dim_IC));
  memcpy(REAL(VECTOR_ELT(state, 216)), odin_model_p->IC, odin_model_p->dim_IC * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 216), 3, odin_model_p->dim_IC_1, odin_model_p->dim_IC_2, odin_model_p->dim_IC_3);
  SET_VECTOR_ELT(state, 217, ScalarInteger(odin_model_p->dim_phi));
  SET_VECTOR_ELT(state, 218, ScalarInteger(odin_model_p->dim_phi_1));
  SET_VECTOR_ELT(state, 219, ScalarInteger(odin_model_p->dim_phi_2));
  SET_VECTOR_ELT(state, 220, ScalarInteger(odin_model_p->dim_phi_3));
  SET_VECTOR_ELT(state, 221, ScalarInteger(odin_model_p->dim_phi_12));
  SET_VECTOR_ELT(state, 222, allocVector(REALSXP, odin_model_p->dim_phi));
  memcpy(REAL(VECTOR_ELT(state, 222)), odin_model_p->phi, odin_model_p->dim_phi * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 222), 3, odin_model_p->dim_phi_1, odin_model_p->dim_phi_2, odin_model_p->dim_phi_3);
  SET_VECTOR_ELT(state, 223, ScalarInteger(odin_model_p->dim_init_IB));
  SET_VECTOR_ELT(state, 224, ScalarInteger(odin_model_p->dim_init_IB_1));
  SET_VECTOR_ELT(state, 225, ScalarInteger(odin_model_p->dim_init_IB_2));
  SET_VECTOR_ELT(state, 226, ScalarInteger(odin_model_p->dim_init_IB_3));
  SET_VECTOR_ELT(state, 227, ScalarInteger(odin_model_p->dim_init_IB_12));
  SET_VECTOR_ELT(state, 228, allocVector(REALSXP, odin_model_p->dim_init_IB));
  memcpy(REAL(VECTOR_ELT(state, 228)), odin_model_p->init_IB, odin_model_p->dim_init_IB * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 228), 3, odin_model_p->dim_init_IB_1, odin_model_p->dim_init_IB_2, odin_model_p->dim_init_IB_3);
  SET_VECTOR_ELT(state, 229, ScalarInteger(odin_model_p->dim_IB));
  SET_VECTOR_ELT(state, 230, ScalarInteger(odin_model_p->dim_IB_1));
  SET_VECTOR_ELT(state, 231, ScalarInteger(odin_model_p->dim_IB_2));
  SET_VECTOR_ELT(state, 232, ScalarInteger(odin_model_p->dim_IB_3));
  SET_VECTOR_ELT(state, 233, ScalarInteger(odin_model_p->dim_IB_12));
  SET_VECTOR_ELT(state, 234, allocVector(REALSXP, odin_model_p->dim_IB));
  memcpy(REAL(VECTOR_ELT(state, 234)), odin_model_p->initial_IB, odin_model_p->dim_IB * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 234), 3, odin_model_p->dim_IB_1, odin_model_p->dim_IB_2, odin_model_p->dim_IB_3);
  SET_VECTOR_ELT(state, 235, ScalarInteger(odin_model_p->offset_IB));
  SET_VECTOR_ELT(state, 236, ScalarInteger(odin_model_p->dim_b));
  SET_VECTOR_ELT(state, 237, ScalarInteger(odin_model_p->dim_b_1));
  SET_VECTOR_ELT(state, 238, ScalarInteger(odin_model_p->dim_b_2));
  SET_VECTOR_ELT(state, 239, ScalarInteger(odin_model_p->dim_b_3));
  SET_VECTOR_ELT(state, 240, ScalarInteger(odin_model_p->dim_b_12));
  SET_VECTOR_ELT(state, 241, allocVector(REALSXP, odin_model_p->dim_b));
  memcpy(REAL(VECTOR_ELT(state, 241)), odin_model_p->b, odin_model_p->dim_b * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 241), 3, odin_model_p->dim_b_1, odin_model_p->dim_b_2, odin_model_p->dim_b_3);
  SET_VECTOR_ELT(state, 242, allocVector(REALSXP, odin_model_p->dim_b));
  memcpy(REAL(VECTOR_ELT(state, 242)), odin_model_p->delay_b, odin_model_p->dim_b * sizeof(double));
  SET_VECTOR_ELT(state, 243, ScalarInteger(odin_model_p->dim_init_ID));
  SET_VECTOR_ELT(state, 244, ScalarInteger(odin_model_p->dim_init_ID_1));
  SET_VECTOR_ELT(state, 245, ScalarInteger(odin_model_p->dim_init_ID_2));
  SET_VECTOR_ELT(state, 246, ScalarInteger(odin_model_p->dim_init_ID_3));
  SET_VECTOR_ELT(state, 247, ScalarInteger(odin_model_p->dim_init_ID_12));
  SET_VECTOR_ELT(state, 248, allocVector(REALSXP, odin_model_p->dim_init_ID));
  memcpy(REAL(VECTOR_ELT(state, 248)), odin_model_p->init_ID, odin_model_p->dim_init_ID * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 248), 3, odin_model_p->dim_init_ID_1, odin_model_p->dim_init_ID_2, odin_model_p->dim_init_ID_3);
  SET_VECTOR_ELT(state, 249, ScalarInteger(odin_model_p->dim_ID));
  SET_VECTOR_ELT(state, 250, ScalarInteger(odin_model_p->dim_ID_1));
  SET_VECTOR_ELT(state, 251, ScalarInteger(odin_model_p->dim_ID_2));
  SET_VECTOR_ELT(state, 252, ScalarInteger(odin_model_p->dim_ID_3));
  SET_VECTOR_ELT(state, 253, ScalarInteger(odin_model_p->dim_ID_12));
  SET_VECTOR_ELT(state, 254, allocVector(REALSXP, odin_model_p->dim_ID));
  memcpy(REAL(VECTOR_ELT(state, 254)), odin_model_p->initial_ID, odin_model_p->dim_ID * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 254), 3, odin_model_p->dim_ID_1, odin_model_p->dim_ID_2, odin_model_p->dim_ID_3);
  SET_VECTOR_ELT(state, 255, ScalarInteger(odin_model_p->offset_ID));
  SET_VECTOR_ELT(state, 256, ScalarInteger(odin_model_p->dim_age));
  SET_VECTOR_ELT(state, 257, allocVector(REALSXP, odin_model_p->dim_age));
  memcpy(REAL(VECTOR_ELT(state, 257)), odin_model_p->age, odin_model_p->dim_age * sizeof(double));
  SET_VECTOR_ELT(state, 258, ScalarInteger(odin_model_p->dim_fd));
  SET_VECTOR_ELT(state, 259, allocVector(REALSXP, odin_model_p->dim_fd));
  memcpy(REAL(VECTOR_ELT(state, 259)), odin_model_p->fd, odin_model_p->dim_fd * sizeof(double));
  SET_VECTOR_ELT(state, 260, ScalarInteger(odin_model_p->dim_p_det));
  SET_VECTOR_ELT(state, 261, ScalarInteger(odin_model_p->dim_p_det_1));
  SET_VECTOR_ELT(state, 262, ScalarInteger(odin_model_p->dim_p_det_2));
  SET_VECTOR_ELT(state, 263, ScalarInteger(odin_model_p->dim_p_det_3));
  SET_VECTOR_ELT(state, 264, ScalarInteger(odin_model_p->dim_p_det_12));
  SET_VECTOR_ELT(state, 265, allocVector(REALSXP, odin_model_p->dim_p_det));
  memcpy(REAL(VECTOR_ELT(state, 265)), odin_model_p->p_det, odin_model_p->dim_p_det * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 265), 3, odin_model_p->dim_p_det_1, odin_model_p->dim_p_det_2, odin_model_p->dim_p_det_3);
  SET_VECTOR_ELT(state, 266, allocVector(REALSXP, odin_model_p->dim_p_det));
  memcpy(REAL(VECTOR_ELT(state, 266)), odin_model_p->delay_p_det, odin_model_p->dim_p_det * sizeof(double));
  SET_VECTOR_ELT(state, 267, ScalarInteger(odin_model_p->dim_FOI_lag));
  SET_VECTOR_ELT(state, 268, ScalarInteger(odin_model_p->dim_FOI_lag_1));
  SET_VECTOR_ELT(state, 269, ScalarInteger(odin_model_p->dim_FOI_lag_2));
  SET_VECTOR_ELT(state, 270, ScalarInteger(odin_model_p->dim_FOI_lag_3));
  SET_VECTOR_ELT(state, 271, ScalarInteger(odin_model_p->dim_FOI_lag_12));
  SET_VECTOR_ELT(state, 272, allocVector(REALSXP, odin_model_p->dim_FOI_lag));
  memcpy(REAL(VECTOR_ELT(state, 272)), odin_model_p->FOI_lag, odin_model_p->dim_FOI_lag * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 272), 3, odin_model_p->dim_FOI_lag_1, odin_model_p->dim_FOI_lag_2, odin_model_p->dim_FOI_lag_3);
  SET_VECTOR_ELT(state, 273, allocVector(REALSXP, odin_model_p->dim_FOI_lag));
  memcpy(REAL(VECTOR_ELT(state, 273)), odin_model_p->delay_FOI_lag, odin_model_p->dim_FOI_lag * sizeof(double));
  SET_VECTOR_ELT(state, 274, ScalarInteger(odin_model_p->dim_FOI));
  SET_VECTOR_ELT(state, 275, ScalarInteger(odin_model_p->dim_FOI_1));
  SET_VECTOR_ELT(state, 276, ScalarInteger(odin_model_p->dim_FOI_2));
  SET_VECTOR_ELT(state, 277, ScalarInteger(odin_model_p->dim_FOI_3));
  SET_VECTOR_ELT(state, 278, ScalarInteger(odin_model_p->dim_FOI_12));
  SET_VECTOR_ELT(state, 279, allocVector(REALSXP, odin_model_p->dim_FOI));
  memcpy(REAL(VECTOR_ELT(state, 279)), odin_model_p->FOI, odin_model_p->dim_FOI * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 279), 3, odin_model_p->dim_FOI_1, odin_model_p->dim_FOI_2, odin_model_p->dim_FOI_3);
  SET_VECTOR_ELT(state, 280, ScalarInteger(odin_model_p->dim_foi_age));
  SET_VECTOR_ELT(state, 281, allocVector(REALSXP, odin_model_p->dim_foi_age));
  memcpy(REAL(VECTOR_ELT(state, 281)), odin_model_p->foi_age, odin_model_p->dim_foi_age * sizeof(double));
  SET_VECTOR_ELT(state, 282, ScalarInteger(odin_model_p->dim_rel_foi));
  SET_VECTOR_ELT(state, 283, allocVector(REALSXP, odin_model_p->dim_rel_foi));
  memcpy(REAL(VECTOR_ELT(state, 283)), odin_model_p->rel_foi, odin_model_p->dim_rel_foi * sizeof(double));
  SET_VECTOR_ELT(state, 284, ScalarInteger(odin_model_p->dim_EIR));
  SET_VECTOR_ELT(state, 285, ScalarInteger(odin_model_p->dim_EIR_1));
  SET_VECTOR_ELT(state, 286, ScalarInteger(odin_model_p->dim_EIR_2));
  SET_VECTOR_ELT(state, 287, ScalarInteger(odin_model_p->dim_EIR_3));
  SET_VECTOR_ELT(state, 288, ScalarInteger(odin_model_p->dim_EIR_12));
  SET_VECTOR_ELT(state, 289, allocVector(REALSXP, odin_model_p->dim_EIR));
  memcpy(REAL(VECTOR_ELT(state, 289)), odin_model_p->EIR, odin_model_p->dim_EIR * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 289), 3, odin_model_p->dim_EIR_1, odin_model_p->dim_EIR_2, odin_model_p->dim_EIR_3);
  SET_VECTOR_ELT(state, 290, allocVector(REALSXP, odin_model_p->dim_EIR));
  memcpy(REAL(VECTOR_ELT(state, 290)), odin_model_p->delay_EIR, odin_model_p->dim_EIR * sizeof(double));
  SET_VECTOR_ELT(state, 291, ScalarReal(odin_model_p->initial_Sv));
  SET_VECTOR_ELT(state, 292, ScalarReal(odin_model_p->initial_Iv));
  SET_VECTOR_ELT(state, 293, ScalarInteger(odin_model_p->dim_cA));
  SET_VECTOR_ELT(state, 294, ScalarInteger(odin_model_p->dim_cA_1));
  SET_VECTOR_ELT(state, 295, ScalarInteger(odin_model_p->dim_cA_2));
  SET_VECTOR_ELT(state, 296, ScalarInteger(odin_model_p->dim_cA_3));
  SET_VECTOR_ELT(state, 297, ScalarInteger(odin_model_p->dim_cA_12));
  SET_VECTOR_ELT(state, 298, allocVector(REALSXP, odin_model_p->dim_cA));
  memcpy(REAL(VECTOR_ELT(state, 298)), odin_model_p->cA, odin_model_p->dim_cA * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 298), 3, odin_model_p->dim_cA_1, odin_model_p->dim_cA_2, odin_model_p->dim_cA_3);
  SET_VECTOR_ELT(state, 299, allocVector(REALSXP, odin_model_p->dim_cA));
  memcpy(REAL(VECTOR_ELT(state, 299)), odin_model_p->delay_cA, odin_model_p->dim_cA * sizeof(double));
  SET_VECTOR_ELT(state, 300, ScalarInteger(odin_model_p->dim_FOIvijk));
  SET_VECTOR_ELT(state, 301, ScalarInteger(odin_model_p->dim_FOIvijk_1));
  SET_VECTOR_ELT(state, 302, ScalarInteger(odin_model_p->dim_FOIvijk_2));
  SET_VECTOR_ELT(state, 303, ScalarInteger(odin_model_p->dim_FOIvijk_3));
  SET_VECTOR_ELT(state, 304, ScalarInteger(odin_model_p->dim_FOIvijk_12));
  SET_VECTOR_ELT(state, 305, allocVector(REALSXP, odin_model_p->dim_FOIvijk));
  memcpy(REAL(VECTOR_ELT(state, 305)), odin_model_p->FOIvijk, odin_model_p->dim_FOIvijk * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 305), 3, odin_model_p->dim_FOIvijk_1, odin_model_p->dim_FOIvijk_2, odin_model_p->dim_FOIvijk_3);
  SET_VECTOR_ELT(state, 306, allocVector(REALSXP, odin_model_p->dim_FOIvijk));
  memcpy(REAL(VECTOR_ELT(state, 306)), odin_model_p->delay_FOIvijk, odin_model_p->dim_FOIvijk * sizeof(double));
  SET_VECTOR_ELT(state, 307, ScalarReal(odin_model_p->b_lambda));
  SET_VECTOR_ELT(state, 308, ScalarReal(odin_model_p->initial_PL));
  SET_VECTOR_ELT(state, 309, ScalarReal(odin_model_p->initial_LL));
  SET_VECTOR_ELT(state, 310, ScalarReal(odin_model_p->initial_EL));
  SET_VECTOR_ELT(state, 311, ScalarInteger(odin_model_p->dim_itn_cov));
  SET_VECTOR_ELT(state, 312, allocVector(REALSXP, odin_model_p->dim_itn_cov));
  memcpy(REAL(VECTOR_ELT(state, 312)), odin_model_p->itn_cov, odin_model_p->dim_itn_cov * sizeof(double));
  SET_VECTOR_ELT(state, 313, ScalarInteger(odin_model_p->dim_irs_cov));
  SET_VECTOR_ELT(state, 314, allocVector(REALSXP, odin_model_p->dim_irs_cov));
  memcpy(REAL(VECTOR_ELT(state, 314)), odin_model_p->irs_cov, odin_model_p->dim_irs_cov * sizeof(double));
  SET_VECTOR_ELT(state, 315, ScalarInteger(odin_model_p->dim_cov));
  SET_VECTOR_ELT(state, 316, allocVector(REALSXP, odin_model_p->dim_cov));
  memcpy(REAL(VECTOR_ELT(state, 316)), odin_model_p->cov, odin_model_p->dim_cov * sizeof(double));
  SET_VECTOR_ELT(state, 317, allocVector(REALSXP, odin_model_p->dim_cov));
  memcpy(REAL(VECTOR_ELT(state, 317)), odin_model_p->delay_cov, odin_model_p->dim_cov * sizeof(double));
  SET_VECTOR_ELT(state, 318, ScalarInteger(odin_model_p->offset_output_cov));
  SET_VECTOR_ELT(state, 319, ScalarInteger(odin_model_p->dim_w));
  SET_VECTOR_ELT(state, 320, allocVector(REALSXP, odin_model_p->dim_w));
  memcpy(REAL(VECTOR_ELT(state, 320)), odin_model_p->w, odin_model_p->dim_w * sizeof(double));
  SET_VECTOR_ELT(state, 321, allocVector(REALSXP, odin_model_p->dim_w));
  memcpy(REAL(VECTOR_ELT(state, 321)), odin_model_p->delay_w, odin_model_p->dim_w * sizeof(double));
  SET_VECTOR_ELT(state, 322, ScalarInteger(odin_model_p->dim_yy));
  SET_VECTOR_ELT(state, 323, allocVector(REALSXP, odin_model_p->dim_yy));
  memcpy(REAL(VECTOR_ELT(state, 323)), odin_model_p->yy, odin_model_p->dim_yy * sizeof(double));
  SET_VECTOR_ELT(state, 324, allocVector(REALSXP, odin_model_p->dim_yy));
  memcpy(REAL(VECTOR_ELT(state, 324)), odin_model_p->delay_yy, odin_model_p->dim_yy * sizeof(double));
  SET_VECTOR_ELT(state, 325, ScalarInteger(odin_model_p->dim_z));
  SET_VECTOR_ELT(state, 326, allocVector(REALSXP, odin_model_p->dim_z));
  memcpy(REAL(VECTOR_ELT(state, 326)), odin_model_p->z, odin_model_p->dim_z * sizeof(double));
  SET_VECTOR_ELT(state, 327, allocVector(REALSXP, odin_model_p->dim_z));
  memcpy(REAL(VECTOR_ELT(state, 327)), odin_model_p->delay_z, odin_model_p->dim_z * sizeof(double));
  SET_VECTOR_ELT(state, 328, ScalarInteger(odin_model_p->dim_zhi));
  SET_VECTOR_ELT(state, 329, allocVector(REALSXP, odin_model_p->dim_zhi));
  memcpy(REAL(VECTOR_ELT(state, 329)), odin_model_p->zhi, odin_model_p->dim_zhi * sizeof(double));
  SET_VECTOR_ELT(state, 330, allocVector(REALSXP, odin_model_p->dim_zhi));
  memcpy(REAL(VECTOR_ELT(state, 330)), odin_model_p->delay_zhi, odin_model_p->dim_zhi * sizeof(double));
  SET_VECTOR_ELT(state, 331, ScalarInteger(odin_model_p->dim_whi));
  SET_VECTOR_ELT(state, 332, allocVector(REALSXP, odin_model_p->dim_whi));
  memcpy(REAL(VECTOR_ELT(state, 332)), odin_model_p->whi, odin_model_p->dim_whi * sizeof(double));
  SET_VECTOR_ELT(state, 333, allocVector(REALSXP, odin_model_p->dim_whi));
  memcpy(REAL(VECTOR_ELT(state, 333)), odin_model_p->delay_whi, odin_model_p->dim_whi * sizeof(double));
  SET_VECTOR_ELT(state, 334, ScalarInteger(odin_model_p->dim_av_mosq));
  SET_VECTOR_ELT(state, 335, allocVector(REALSXP, odin_model_p->dim_av_mosq));
  memcpy(REAL(VECTOR_ELT(state, 335)), odin_model_p->av_mosq, odin_model_p->dim_av_mosq * sizeof(double));
  SET_VECTOR_ELT(state, 336, allocVector(REALSXP, odin_model_p->dim_av_mosq));
  memcpy(REAL(VECTOR_ELT(state, 336)), odin_model_p->delay_av_mosq, odin_model_p->dim_av_mosq * sizeof(double));
  SET_VECTOR_ELT(state, 337, ScalarInteger(odin_model_p->dim_av_human));
  SET_VECTOR_ELT(state, 338, allocVector(REALSXP, odin_model_p->dim_av_human));
  memcpy(REAL(VECTOR_ELT(state, 338)), odin_model_p->av_human, odin_model_p->dim_av_human * sizeof(double));
  SET_VECTOR_ELT(state, 339, allocVector(REALSXP, odin_model_p->dim_av_human));
  memcpy(REAL(VECTOR_ELT(state, 339)), odin_model_p->delay_av_human, odin_model_p->dim_av_human * sizeof(double));
  SET_VECTOR_ELT(state, 340, ScalarInteger(odin_model_p->dim_den));
  SET_VECTOR_ELT(state, 341, allocVector(REALSXP, odin_model_p->dim_den));
  memcpy(REAL(VECTOR_ELT(state, 341)), odin_model_p->den, odin_model_p->dim_den * sizeof(double));
  SET_VECTOR_ELT(state, 342, ScalarInteger(odin_model_p->dim_prev0to59));
  SET_VECTOR_ELT(state, 343, ScalarInteger(odin_model_p->dim_prev0to59_1));
  SET_VECTOR_ELT(state, 344, ScalarInteger(odin_model_p->dim_prev0to59_2));
  SET_VECTOR_ELT(state, 345, ScalarInteger(odin_model_p->dim_prev0to59_3));
  SET_VECTOR_ELT(state, 346, ScalarInteger(odin_model_p->dim_prev0to59_12));
  SET_VECTOR_ELT(state, 347, allocVector(REALSXP, odin_model_p->dim_prev0to59));
  memcpy(REAL(VECTOR_ELT(state, 347)), odin_model_p->prev0to59, odin_model_p->dim_prev0to59 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 347), 3, odin_model_p->dim_prev0to59_1, odin_model_p->dim_prev0to59_2, odin_model_p->dim_prev0to59_3);
  SET_VECTOR_ELT(state, 348, ScalarInteger(odin_model_p->dim_clin_inc0to5));
  SET_VECTOR_ELT(state, 349, ScalarInteger(odin_model_p->dim_clin_inc0to5_1));
  SET_VECTOR_ELT(state, 350, ScalarInteger(odin_model_p->dim_clin_inc0to5_2));
  SET_VECTOR_ELT(state, 351, ScalarInteger(odin_model_p->dim_clin_inc0to5_3));
  SET_VECTOR_ELT(state, 352, ScalarInteger(odin_model_p->dim_clin_inc0to5_12));
  SET_VECTOR_ELT(state, 353, allocVector(REALSXP, odin_model_p->dim_clin_inc0to5));
  memcpy(REAL(VECTOR_ELT(state, 353)), odin_model_p->clin_inc0to5, odin_model_p->dim_clin_inc0to5 * sizeof(double));
  odin_set_dim(VECTOR_ELT(state, 353), 3, odin_model_p->dim_clin_inc0to5_1, odin_model_p->dim_clin_inc0to5_2, odin_model_p->dim_clin_inc0to5_3);
  SET_VECTOR_ELT(state, 354, ScalarInteger(odin_model_p->dim_delay_FOI));
  SET_VECTOR_ELT(state, 355, allocVector(INTSXP, odin_model_p->dim_delay_FOI));
  memcpy(INTEGER(VECTOR_ELT(state, 355)), odin_model_p->delay_i_FOI, odin_model_p->dim_delay_FOI * sizeof(int));
  SET_VECTOR_ELT(state, 356, allocVector(REALSXP, odin_model_p->dim_delay_FOI));
  memcpy(REAL(VECTOR_ELT(state, 356)), odin_model_p->delay_state_FOI, odin_model_p->dim_delay_FOI * sizeof(double));
  SET_VECTOR_ELT(state, 357, ScalarInteger(odin_model_p->dim_delay_FOIv));
  SET_VECTOR_ELT(state, 358, allocVector(INTSXP, odin_model_p->dim_delay_FOIv));
  memcpy(INTEGER(VECTOR_ELT(state, 358)), odin_model_p->delay_i_FOIv, odin_model_p->dim_delay_FOIv * sizeof(int));
  SET_VECTOR_ELT(state, 359, allocVector(REALSXP, odin_model_p->dim_delay_FOIv));
  memcpy(REAL(VECTOR_ELT(state, 359)), odin_model_p->delay_state_FOIv, odin_model_p->dim_delay_FOIv * sizeof(double));
  SET_VECTOR_ELT(state, 360, ScalarInteger(odin_model_p->dim_delay_incv));
  SET_VECTOR_ELT(state, 361, allocVector(INTSXP, odin_model_p->dim_delay_incv));
  memcpy(INTEGER(VECTOR_ELT(state, 361)), odin_model_p->delay_i_incv, odin_model_p->dim_delay_incv * sizeof(int));
  SET_VECTOR_ELT(state, 362, allocVector(REALSXP, odin_model_p->dim_delay_incv));
  memcpy(REAL(VECTOR_ELT(state, 362)), odin_model_p->delay_state_incv, odin_model_p->dim_delay_incv * sizeof(double));
  SET_VECTOR_ELT(state, 363, ScalarInteger(odin_model_p->dim));
  SET_VECTOR_ELT(state, 364, ScalarInteger(odin_model_p->dim_output));
  SEXP state_names = PROTECT(allocVector(STRSXP, 365));
  ...
  SET_STRING_ELT(state_names, 67, mkChar("betaL"));
  ...
  SET_STRING_ELT(state_names, 73, mkChar("int_len"));
  SET_STRING_ELT(state_names, 74, mkChar("IRS_interval"));
  SET_STRING_ELT(state_names, 75, mkChar("ITN_interval"));
  SET_STRING_ELT(state_names, 76, mkChar("chi"));
  SET_STRING_ELT(state_names, 77, mkChar("Q0"));
  SET_STRING_ELT(state_names, 78, mkChar("bites_Bed"));
  SET_STRING_ELT(state_names, 79, mkChar("bites_Indoors"));
  SET_STRING_ELT(state_names, 80, mkChar("r_ITN0"));
  SET_STRING_ELT(state_names, 81, mkChar("d_ITN0"));
  SET_STRING_ELT(state_names, 82, mkChar("d_IRS0"));
  SET_STRING_ELT(state_names, 83, mkChar("r_IRS0"));
  SET_STRING_ELT(state_names, 84, mkChar("r_ITN1"));
  SET_STRING_ELT(state_names, 85, mkChar("irs_loss"));
  SET_STRING_ELT(state_names, 86, mkChar("itn_loss"));
  SET_STRING_ELT(state_names, 87, mkChar("age59"));
  SET_STRING_ELT(state_names, 88, mkChar("age05"));
  SET_STRING_ELT(state_names, 89, mkChar("dim_age_rate"));
  SET_STRING_ELT(state_names, 90, mkChar("age_rate"));
  SET_STRING_ELT(state_names, 91, mkChar("dim_het_wt"));
  SET_STRING_ELT(state_names, 92, mkChar("het_wt"));
  SET_STRING_ELT(state_names, 93, mkChar("dim_init_S"));
  SET_STRING_ELT(state_names, 94, mkChar("dim_init_S_1"));
  SET_STRING_ELT(state_names, 95, mkChar("dim_init_S_2"));
  SET_STRING_ELT(state_names, 96, mkChar("dim_init_S_3"));
  SET_STRING_ELT(state_names, 97, mkChar("dim_init_S_12"));
  SET_STRING_ELT(state_names, 98, mkChar("init_S"));
  SET_STRING_ELT(state_names, 99, mkChar("dim_S"));
  SET_STRING_ELT(state_names, 100, mkChar("dim_S_1"));
  SET_STRING_ELT(state_names, 101, mkChar("dim_S_2"));
  SET_STRING_ELT(state_names, 102, mkChar("dim_S_3"));
  SET_STRING_ELT(state_names, 103, mkChar("dim_S_12"));
  SET_STRING_ELT(state_names, 104, mkChar("initial_S"));
  SET_STRING_ELT(state_names, 105, mkChar("offset_S"));
  SET_STRING_ELT(state_names, 106, mkChar("dim_init_T"));
  SET_STRING_ELT(state_names, 107, mkChar("dim_init_T_1"));
  SET_STRING_ELT(state_names, 108, mkChar("dim_init_T_2"));
  SET_STRING_ELT(state_names, 109, mkChar("dim_init_T_3"));
  SET_STRING_ELT(state_names, 110, mkChar("dim_init_T_12"));
  SET_STRING_ELT(state_names, 111, mkChar("init_T"));
  SET_STRING_ELT(state_names, 112, mkChar("dim_T"));
  SET_STRING_ELT(state_names, 113, mkChar("dim_T_1"));
  SET_STRING_ELT(state_names, 114, mkChar("dim_T_2"));
  SET_STRING_ELT(state_names, 115, mkChar("dim_T_3"));
  SET_STRING_ELT(state_names, 116, mkChar("dim_T_12"));
  SET_STRING_ELT(state_names, 117, mkChar("initial_T"));
  SET_STRING_ELT(state_names, 118, mkChar("offset_T"));
  SET_STRING_ELT(state_names, 119, mkChar("dim_init_D"));
  SET_STRING_ELT(state_names, 120, mkChar("dim_init_D_1"));
  SET_STRING_ELT(state_names, 121, mkChar("dim_init_D_2"));
  SET_STRING_ELT(state_names, 122, mkChar("dim_init_D_3"));
  SET_STRING_ELT(state_names, 123, mkChar("dim_init_D_12"));
  SET_STRING_ELT(state_names, 124, mkChar("init_D"));
  SET_STRING_ELT(state_names, 125, mkChar("dim_D"));
  SET_STRING_ELT(state_names, 126, mkChar("dim_D_1"));
  SET_STRING_ELT(state_names, 127, mkChar("dim_D_2"));
  SET_STRING_ELT(state_names, 128, mkChar("dim_D_3"));
  SET_STRING_ELT(state_names, 129, mkChar("dim_D_12"));
  SET_STRING_ELT(state_names, 130, mkChar("initial_D"));
  SET_STRING_ELT(state_names, 131, mkChar("offset_D"));
  SET_STRING_ELT(state_names, 132, mkChar("dim_init_A"));
  SET_STRING_ELT(state_names, 133, mkChar("dim_init_A_1"));
  SET_STRING_ELT(state_names, 134, mkChar("dim_init_A_2"));
  SET_STRING_ELT(state_names, 135, mkChar("dim_init_A_3"));
  SET_STRING_ELT(state_names, 136, mkChar("dim_init_A_12"));
  SET_STRING_ELT(state_names, 137, mkChar("init_A"));
  SET_STRING_ELT(state_names, 138, mkChar("dim_A"));
  SET_STRING_ELT(state_names, 139, mkChar("dim_A_1"));
  SET_STRING_ELT(state_names, 140, mkChar("dim_A_2"));
  SET_STRING_ELT(state_names, 141, mkChar("dim_A_3"));
  SET_STRING_ELT(state_names, 142, mkChar("dim_A_12"));
  SET_STRING_ELT(state_names, 143, mkChar("initial_A"));
  SET_STRING_ELT(state_names, 144, mkChar("offset_A"));
  SET_STRING_ELT(state_names, 145, mkChar("dim_init_U"));
  SET_STRING_ELT(state_names, 146, mkChar("dim_init_U_1"));
  SET_STRING_ELT(state_names, 147, mkChar("dim_init_U_2"));
  SET_STRING_ELT(state_names, 148, mkChar("dim_init_U_3"));
  SET_STRING_ELT(state_names, 149, mkChar("dim_init_U_12"));
  SET_STRING_ELT(state_names, 150, mkChar("init_U"));
  SET_STRING_ELT(state_names, 151, mkChar("dim_U"));
  SET_STRING_ELT(state_names, 152, mkChar("dim_U_1"));
  SET_STRING_ELT(state_names, 153, mkChar("dim_U_2"));
  SET_STRING_ELT(state_names, 154, mkChar("dim_U_3"));
  SET_STRING_ELT(state_names, 155, mkChar("dim_U_12"));
  SET_STRING_ELT(state_names, 156, mkChar("initial_U"));
  SET_STRING_ELT(state_names, 157, mkChar("offset_U"));
  SET_STRING_ELT(state_names, 158, mkChar("dim_init_P"));
  SET_STRING_ELT(state_names, 159, mkChar("dim_init_P_1"));
  SET_STRING_ELT(state_names, 160, mkChar("dim_init_P_2"));
  SET_STRING_ELT(state_names, 161, mkChar("dim_init_P_3"));
  SET_STRING_ELT(state_names, 162, mkChar("dim_init_P_12"));
  SET_STRING_ELT(state_names, 163, mkChar("init_P"));
  SET_STRING_ELT(state_names, 164, mkChar("dim_P"));
  SET_STRING_ELT(state_names, 165, mkChar("dim_P_1"));
  SET_STRING_ELT(state_names, 166, mkChar("dim_P_2"));
  SET_STRING_ELT(state_names, 167, mkChar("dim_P_3"));
  SET_STRING_ELT(state_names, 168, mkChar("dim_P_12"));
  SET_STRING_ELT(state_names, 169, mkChar("initial_P"));
  SET_STRING_ELT(state_names, 170, mkChar("offset_P"));
  SET_STRING_ELT(state_names, 171, mkChar("dim_Y"));
  SET_STRING_ELT(state_names, 172, mkChar("dim_Y_1"));
  SET_STRING_ELT(state_names, 173, mkChar("dim_Y_2"));
  SET_STRING_ELT(state_names, 174, mkChar("dim_Y_3"));
  SET_STRING_ELT(state_names, 175, mkChar("dim_Y_12"));
  SET_STRING_ELT(state_names, 176, mkChar("Y"));
  SET_STRING_ELT(state_names, 177, mkChar("dim_clin_inc"));
  SET_STRING_ELT(state_names, 178, mkChar("dim_clin_inc_1"));
  SET_STRING_ELT(state_names, 179, mkChar("dim_clin_inc_2"));
  SET_STRING_ELT(state_names, 180, mkChar("dim_clin_inc_3"));
  SET_STRING_ELT(state_names, 181, mkChar("dim_clin_inc_12"));
  SET_STRING_ELT(state_names, 182, mkChar("clin_inc"));
  SET_STRING_ELT(state_names, 183, mkChar("dim_x_I"));
  SET_STRING_ELT(state_names, 184, mkChar("x_I"));
  SET_STRING_ELT(state_names, 185, mkChar("dim_init_ICM"));
  SET_STRING_ELT(state_names, 186, mkChar("dim_init_ICM_1"));
  SET_STRING_ELT(state_names, 187, mkChar("dim_init_ICM_2"));
  SET_STRING_ELT(state_names, 188, mkChar("dim_init_ICM_3"));
  SET_STRING_ELT(state_names, 189, mkChar("dim_init_ICM_12"));
  SET_STRING_ELT(state_names, 190, mkChar("init_ICM"));
  SET_STRING_ELT(state_names, 191, mkChar("dim_ICM"));
  SET_STRING_ELT(state_names, 192, mkChar("dim_ICM_1"));
  SET_STRING_ELT(state_names, 193, mkChar("dim_ICM_2"));
  SET_STRING_ELT(state_names, 194, mkChar("dim_ICM_3"));
  SET_STRING_ELT(state_names, 195, mkChar("dim_ICM_12"));
  SET_STRING_ELT(state_names, 196, mkChar("initial_ICM"));
  SET_STRING_ELT(state_names, 197, mkChar("offset_ICM"));
  SET_STRING_ELT(state_names, 198, mkChar("dim_init_ICA"));
  SET_STRING_ELT(state_names, 199, mkChar("dim_init_ICA_1"));
  SET_STRING_ELT(state_names, 200, mkChar("dim_init_ICA_2"));
  SET_STRING_ELT(state_names, 201, mkChar("dim_init_ICA_3"));
  SET_STRING_ELT(state_names, 202, mkChar("dim_init_ICA_12"));
  SET_STRING_ELT(state_names, 203, mkChar("init_ICA"));
  SET_STRING_ELT(state_names, 204, mkChar("dim_ICA"));
  SET_STRING_ELT(state_names, 205, mkChar("dim_ICA_1"));
  SET_STRING_ELT(state_names, 206, mkChar("dim_ICA_2"));
  SET_STRING_ELT(state_names, 207, mkChar("dim_ICA_3"));
  SET_STRING_ELT(state_names, 208, mkChar("dim_ICA_12"));
  SET_STRING_ELT(state_names, 209, mkChar("initial_ICA"));
  SET_STRING_ELT(state_names, 210, mkChar("offset_ICA"));
  SET_STRING_ELT(state_names, 211, mkChar("dim_IC"));
  SET_STRING_ELT(state_names, 212, mkChar("dim_IC_1"));
  SET_STRING_ELT(state_names, 213, mkChar("dim_IC_2"));
  SET_STRING_ELT(state_names, 214, mkChar("dim_IC_3"));
  SET_STRING_ELT(state_names, 215, mkChar("dim_IC_12"));
  SET_STRING_ELT(state_names, 216, mkChar("IC"));
  SET_STRING_ELT(state_names, 217, mkChar("dim_phi"));
  SET_STRING_ELT(state_names, 218, mkChar("dim_phi_1"));
  SET_STRING_ELT(state_names, 219, mkChar("dim_phi_2"));
  SET_STRING_ELT(state_names, 220, mkChar("dim_phi_3"));
  SET_STRING_ELT(state_names, 221, mkChar("dim_phi_12"));
  SET_STRING_ELT(state_names, 222, mkChar("phi"));
  SET_STRING_ELT(state_names, 223, mkChar("dim_init_IB"));
  SET_STRING_ELT(state_names, 224, mkChar("dim_init_IB_1"));
  SET_STRING_ELT(state_names, 225, mkChar("dim_init_IB_2"));
  SET_STRING_ELT(state_names, 226, mkChar("dim_init_IB_3"));
  SET_STRING_ELT(state_names, 227, mkChar("dim_init_IB_12"));
  SET_STRING_ELT(state_names, 228, mkChar("init_IB"));
  SET_STRING_ELT(state_names, 229, mkChar("dim_IB"));
  SET_STRING_ELT(state_names, 230, mkChar("dim_IB_1"));
  SET_STRING_ELT(state_names, 231, mkChar("dim_IB_2"));
  SET_STRING_ELT(state_names, 232, mkChar("dim_IB_3"));
  SET_STRING_ELT(state_names, 233, mkChar("dim_IB_12"));
  SET_STRING_ELT(state_names, 234, mkChar("initial_IB"));
  SET_STRING_ELT(state_names, 235, mkChar("offset_IB"));
  SET_STRING_ELT(state_names, 236, mkChar("dim_b"));
  SET_STRING_ELT(state_names, 237, mkChar("dim_b_1"));
  SET_STRING_ELT(state_names, 238, mkChar("dim_b_2"));
  SET_STRING_ELT(state_names, 239, mkChar("dim_b_3"));
  SET_STRING_ELT(state_names, 240, mkChar("dim_b_12"));
  SET_STRING_ELT(state_names, 241, mkChar("b"));
  SET_STRING_ELT(state_names, 242, mkChar("delay_b"));
  SET_STRING_ELT(state_names, 243, mkChar("dim_init_ID"));
  SET_STRING_ELT(state_names, 244, mkChar("dim_init_ID_1"));
  SET_STRING_ELT(state_names, 245, mkChar("dim_init_ID_2"));
  SET_STRING_ELT(state_names, 246, mkChar("dim_init_ID_3"));
  SET_STRING_ELT(state_names, 247, mkChar("dim_init_ID_12"));
  SET_STRING_ELT(state_names, 248, mkChar("init_ID"));
  SET_STRING_ELT(state_names, 249, mkChar("dim_ID"));
  SET_STRING_ELT(state_names, 250, mkChar("dim_ID_1"));
  SET_STRING_ELT(state_names, 251, mkChar("dim_ID_2"));
  SET_STRING_ELT(state_names, 252, mkChar("dim_ID_3"));
  SET_STRING_ELT(state_names, 253, mkChar("dim_ID_12"));
  SET_STRING_ELT(state_names, 254, mkChar("initial_ID"));
  SET_STRING_ELT(state_names, 255, mkChar("offset_ID"));
  SET_STRING_ELT(state_names, 256, mkChar("dim_age"));
  SET_STRING_ELT(state_names, 257, mkChar("age"));
  SET_STRING_ELT(state_names, 258, mkChar("dim_fd"));
  SET_STRING_ELT(state_names, 259, mkChar("fd"));
  SET_STRING_ELT(state_names, 260, mkChar("dim_p_det"));
  SET_STRING_ELT(state_names, 261, mkChar("dim_p_det_1"));
  SET_STRING_ELT(state_names, 262, mkChar("dim_p_det_2"));
  SET_STRING_ELT(state_names, 263, mkChar("dim_p_det_3"));
  SET_STRING_ELT(state_names, 264, mkChar("dim_p_det_12"));
  SET_STRING_ELT(state_names, 265, mkChar("p_det"));
  SET_STRING_ELT(state_names, 266, mkChar("delay_p_det"));
  SET_STRING_ELT(state_names, 267, mkChar("dim_FOI_lag"));
  SET_STRING_ELT(state_names, 268, mkChar("dim_FOI_lag_1"));
  SET_STRING_ELT(state_names, 269, mkChar("dim_FOI_lag_2"));
  SET_STRING_ELT(state_names, 270, mkChar("dim_FOI_lag_3"));
  SET_STRING_ELT(state_names, 271, mkChar("dim_FOI_lag_12"));
  SET_STRING_ELT(state_names, 272, mkChar("FOI_lag"));
  SET_STRING_ELT(state_names, 273, mkChar("delay_FOI_lag"));
  SET_STRING_ELT(state_names, 274, mkChar("dim_FOI"));
  SET_STRING_ELT(state_names, 275, mkChar("dim_FOI_1"));
  SET_STRING_ELT(state_names, 276, mkChar("dim_FOI_2"));
  SET_STRING_ELT(state_names, 277, mkChar("dim_FOI_3"));
  SET_STRING_ELT(state_names, 278, mkChar("dim_FOI_12"));
  SET_STRING_ELT(state_names, 279, mkChar("FOI"));
  SET_STRING_ELT(state_names, 280, mkChar("dim_foi_age"));
  SET_STRING_ELT(state_names, 281, mkChar("foi_age"));
  SET_STRING_ELT(state_names, 282, mkChar("dim_rel_foi"));
  SET_STRING_ELT(state_names, 283, mkChar("rel_foi"));
  SET_STRING_ELT(state_names, 284, mkChar("dim_EIR"));
  SET_STRING_ELT(state_names, 285, mkChar("dim_EIR_1"));
  SET_STRING_ELT(state_names, 286, mkChar("dim_EIR_2"));
  SET_STRING_ELT(state_names, 287, mkChar("dim_EIR_3"));
  SET_STRING_ELT(state_names, 288, mkChar("dim_EIR_12"));
  SET_STRING_ELT(state_names, 289, mkChar("EIR"));
  SET_STRING_ELT(state_names, 290, mkChar("delay_EIR"));
  SET_STRING_ELT(state_names, 291, mkChar("initial_Sv"));
  SET_STRING_ELT(state_names, 292, mkChar("initial_Iv"));
  SET_STRING_ELT(state_names, 293, mkChar("dim_cA"));
  SET_STRING_ELT(state_names, 294, mkChar("dim_cA_1"));
  SET_STRING_ELT(state_names, 295, mkChar("dim_cA_2"));
  SET_STRING_ELT(state_names, 296, mkChar("dim_cA_3"));
  SET_STRING_ELT(state_names, 297, mkChar("dim_cA_12"));
  SET_STRING_ELT(state_names, 298, mkChar("cA"));
  SET_STRING_ELT(state_names, 299, mkChar("delay_cA"));
  SET_STRING_ELT(state_names, 300, mkChar("dim_FOIvijk"));
  SET_STRING_ELT(state_names, 301, mkChar("dim_FOIvijk_1"));
  SET_STRING_ELT(state_names, 302, mkChar("dim_FOIvijk_2"));
  SET_STRING_ELT(state_names, 303, mkChar("dim_FOIvijk_3"));
  SET_STRING_ELT(state_names, 304, mkChar("dim_FOIvijk_12"));
  SET_STRING_ELT(state_names, 305, mkChar("FOIvijk"));
  SET_STRING_ELT(state_names, 306, mkChar("delay_FOIvijk"));
  SET_STRING_ELT(state_names, 307, mkChar("b_lambda"));
  SET_STRING_ELT(state_names, 308, mkChar("initial_PL"));
  SET_STRING_ELT(state_names, 309, mkChar("initial_LL"));
  SET_STRING_ELT(state_names, 310, mkChar("initial_EL"));
  SET_STRING_ELT(state_names, 311, mkChar("dim_itn_cov"));
  SET_STRING_ELT(state_names, 312, mkChar("itn_cov"));
  SET_STRING_ELT(state_names, 313, mkChar("dim_irs_cov"));
  SET_STRING_ELT(state_names, 314, mkChar("irs_cov"));
  SET_STRING_ELT(state_names, 315, mkChar("dim_cov"));
  SET_STRING_ELT(state_names, 316, mkChar("cov"));
  SET_STRING_ELT(state_names, 317, mkChar("delay_cov"));
  SET_STRING_ELT(state_names, 318, mkChar("offset_output_cov"));
  SET_STRING_ELT(state_names, 319, mkChar("dim_w"));
  SET_STRING_ELT(state_names, 320, mkChar("w"));
  SET_STRING_ELT(state_names, 321, mkChar("delay_w"));
  SET_STRING_ELT(state_names, 322, mkChar("dim_yy"));
  SET_STRING_ELT(state_names, 323, mkChar("yy"));
  SET_STRING_ELT(state_names, 324, mkChar("delay_yy"));
  SET_STRING_ELT(state_names, 325, mkChar("dim_z"));
  SET_STRING_ELT(state_names, 326, mkChar("z"));
  SET_STRING_ELT(state_names, 327, mkChar("delay_z"));
  SET_STRING_ELT(state_names, 328, mkChar("dim_zhi"));
  SET_STRING_ELT(state_names, 329, mkChar("zhi"));
  SET_STRING_ELT(state_names, 330, mkChar("delay_zhi"));
  SET_STRING_ELT(state_names, 331, mkChar("dim_whi"));
  SET_STRING_ELT(state_names, 332, mkChar("whi"));
  SET_STRING_ELT(state_names, 333, mkChar("delay_whi"));
  SET_STRING_ELT(state_names, 334, mkChar("dim_av_mosq"));
  SET_STRING_ELT(state_names, 335, mkChar("av_mosq"));
  SET_STRING_ELT(state_names, 336, mkChar("delay_av_mosq"));
  SET_STRING_ELT(state_names, 337, mkChar("dim_av_human"));
  SET_STRING_ELT(state_names, 338, mkChar("av_human"));
  SET_STRING_ELT(state_names, 339, mkChar("delay_av_human"));
  SET_STRING_ELT(state_names, 340, mkChar("dim_den"));
  SET_STRING_ELT(state_names, 341, mkChar("den"));
  SET_STRING_ELT(state_names, 342, mkChar("dim_prev0to59"));
  SET_STRING_ELT(state_names, 343, mkChar("dim_prev0to59_1"));
  SET_STRING_ELT(state_names, 344, mkChar("dim_prev0to59_2"));
  SET_STRING_ELT(state_names, 345, mkChar("dim_prev0to59_3"));
  SET_STRING_ELT(state_names, 346, mkChar("dim_prev0to59_12"));
  SET_STRING_ELT(state_names, 347, mkChar("prev0to59"));
  SET_STRING_ELT(state_names, 348, mkChar("dim_clin_inc0to5"));
  SET_STRING_ELT(state_names, 349, mkChar("dim_clin_inc0to5_1"));
  SET_STRING_ELT(state_names, 350, mkChar("dim_clin_inc0to5_2"));
  SET_STRING_ELT(state_names, 351, mkChar("dim_clin_inc0to5_3"));
  SET_STRING_ELT(state_names, 352, mkChar("dim_clin_inc0to5_12"));
  SET_STRING_ELT(state_names, 353, mkChar("clin_inc0to5"));
  SET_STRING_ELT(state_names, 354, mkChar("dim_delay_FOI"));
  SET_STRING_ELT(state_names, 355, mkChar("delay_i_FOI"));
  SET_STRING_ELT(state_names, 356, mkChar("delay_state_FOI"));
  SET_STRING_ELT(state_names, 357, mkChar("dim_delay_FOIv"));
  SET_STRING_ELT(state_names, 358, mkChar("delay_i_FOIv"));
  SET_STRING_ELT(state_names, 359, mkChar("delay_state_FOIv"));
  SET_STRING_ELT(state_names, 360, mkChar("dim_delay_incv"));
  SET_STRING_ELT(state_names, 361, mkChar("delay_i_incv"));
  SET_STRING_ELT(state_names, 362, mkChar("delay_state_incv"));
  SET_STRING_ELT(state_names, 363, mkChar("dim"));
  SET_STRING_ELT(state_names, 364, mkChar("dim_output"));
...
SEXP odin_model_output_order(SEXP odin_model_ptr) {
  odin_model_pars *odin_model_p = odin_model_get_pointer(odin_model_ptr, 1);
  SEXP state_len = PROTECT(allocVector(VECSXP, 24));
  ...
  SET_STRING_ELT(state_names, 10, mkChar("fv"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("beta_larval"));
  SET_VECTOR_ELT(state_len, 12, R_NilValue);
  SET_STRING_ELT(state_names, 12, mkChar("KL"));
  SET_VECTOR_ELT(state_len, 13, R_NilValue);
  SET_STRING_ELT(state_names, 13, mkChar("mv"));
  SET_VECTOR_ELT(state_len, 14, R_NilValue);
  SET_STRING_ELT(state_names, 14, mkChar("Q"));
  SET_VECTOR_ELT(state_len, 15, R_NilValue);
  SET_STRING_ELT(state_names, 15, mkChar("wh"));
  SET_VECTOR_ELT(state_len, 16, R_NilValue);
  SET_STRING_ELT(state_names, 16, mkChar("d_ITN"));
  SET_VECTOR_ELT(state_len, 17, R_NilValue);
  SET_STRING_ELT(state_names, 17, mkChar("r_ITN"));
  SET_VECTOR_ELT(state_len, 18, R_NilValue);
  SET_STRING_ELT(state_names, 18, mkChar("s_ITN"));
  SET_VECTOR_ELT(state_len, 19, R_NilValue);
  SET_STRING_ELT(state_names, 19, mkChar("d_IRS"));
  SET_VECTOR_ELT(state_len, 20, R_NilValue);
  SET_STRING_ELT(state_names, 20, mkChar("r_IRS"));
  SET_VECTOR_ELT(state_len, 21, R_NilValue);
  SET_STRING_ELT(state_names, 21, mkChar("s_IRS"));
  SET_VECTOR_ELT(state_len, 22, R_NilValue);
  SET_STRING_ELT(state_names, 22, mkChar("K0"));
  SET_VECTOR_ELT(state_len, 23, ScalarInteger(odin_model_p->dim_cov));
  SET_STRING_ELT(state_names, 23, mkChar("cov"));
  setAttrib(state_len, R_NamesSymbol, state_names);
  UNPROTECT(2);
  return state_len;
}
