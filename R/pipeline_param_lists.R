...
#' @param resistance_diagnostic_flag Boolean are we doing resistance diagnostics
...
drug_list_create <- function(resistance_flag = FALSE,
                             ...
                             mft_flag = FALSE,
                             resistance_diagnostic_flag = FALSE,
                             temporal_cycling = -1,
  ...
  l <- list("resistance_flag" = resistance_flag,
            ...
            "drugs" = drugs,
            "mft_flag" = mft_flag,
            "resistance_diagnostic_flag" = resistance_diagnostic_flag,
