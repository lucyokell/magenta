...
## S | D | A | U | T | P:
## 0.1132 | 0.0058 | 0.7837 | 0.087 | 0.0024 | 0.0079 |
```
...
## Starting susceptible population: 0.1132
## Time elapsed in initialisation: 0 seconds
## 800 days
## 900 days
## 1000 days
...
## S | D | A | U | T | P:
## 0.1156 | 0.0037 | 0.7776 | 0.0899 | 0.0032 | 0.01 |
```
...
##   ..$ Infection_States                  : int [1:10000] 2 2 ...
##   ..$ Zetas                             : num [1:10000] 0.297 ...
##   ..$ Ages                              : num [1:10000] 4436 ...
##   ..$ IB                                : num [1:10000] 197 ...
##   ..$ ICA                               : num [1:10000] 206 ...
##   ..$ ICM                               : num [1:10000] 1.18e-23 ...
##   ..$ ID                                : num [1:10000] 109 ...
##   ..$ IB_last_boost_time                : int [1:10000] 1085 1091 ...
##   ..$ ICA_last_boost_time               : int [1:10000] 1071 1095 ...
##   ..$ ID_last_boost_time                : int [1:10000] 1071 1096 ...
##   ..$ IB_last_calculated_time           : int [1:10000] 1091 1096 ...
##   ..$ I_C_D_CM_last_calculated_time     : int [1:10000] 1071 1096 ...
##   ..$ Immunity_boost_float              : int [1:10000] 0 0 ...
##   ..$ Day_of_InfectionStatus_change     : int [1:10000] 1193 1209 ...
##   ..$ Day_of_strain_clearance           : int [1:10000] 1137 1103 ...
##   ..$ Day_of_death                      : int [1:10000] 3845 9154 ...
...
##   ..$ g_sum_maternal_immunity : int 76903
##   ..$ g_total_mums            : int 196
```
